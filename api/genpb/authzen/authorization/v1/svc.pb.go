...
const file_authzen_authorization_v1_svc_proto_rawDesc = "" +
	...
	"\x10AccessEvaluation\x121.authzen.authorization.v1.AccessEvaluationRequest\x1a2.authzen.authorization.v1.AccessEvaluationResponse\"\x9f\x01\x92A|\x12\x17Evaluate access request\x1aaEvaluate whether a subject can perform an action on a resource according to AuthZEN specification\x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/access/v1/evaluation\x1a9\x92A6\x124AuthZEN Authorization Service for access evaluationsB\xcd\x02\x92A\xbb\x01\x12\x91\x01\n" +
