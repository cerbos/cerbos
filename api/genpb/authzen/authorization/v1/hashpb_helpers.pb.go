...
func authzen_authorization_v1_MetadataResponse_hashpb_sum(m *MetadataResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["authzen.authorization.v1.MetadataResponse.policy_decision_point"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetPolicyDecisionPoint()))))
	...
	if _, ok := ignore["authzen.authorization.v1.MetadataResponse.access_evaluation_endpoint"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetAccessEvaluationEndpoint()))))
	...
	if _, ok := ignore["authzen.authorization.v1.MetadataResponse.access_evaluations_endpoint"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetAccessEvaluationsEndpoint()))))
