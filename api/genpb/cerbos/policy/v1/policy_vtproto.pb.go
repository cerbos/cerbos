...
func (m *Policy_ExportConstants) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ExportConstants != nil {
		size, err := m.ExportConstants.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TestTable_Input) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.PrincipalGroups) > 0 {
		for iNdEx := len(m.PrincipalGroups) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.PrincipalGroups[iNdEx])
			copy(dAtA[i:], m.PrincipalGroups[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.PrincipalGroups[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (m *TestResults_Details) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.EngineTraceBatch != nil {
		if vtmsg, ok := interface{}(m.EngineTraceBatch).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.EngineTraceBatch)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *TestResults_OutputFailure_Errored) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Errored != nil {
		size, err := m.Errored.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TestFixture_Principals) SizeVT() (n int) {
	...
	if len(m.PrincipalGroups) > 0 {
		for k, v := range m.PrincipalGroups {
			_ = k
			_ = v
			l = 0
			if v != nil {
...
func (m *TestTable_Input) SizeVT() (n int) {
	...
	if len(m.PrincipalGroups) > 0 {
		for _, s := range m.PrincipalGroups {
			l = len(s)
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *TestResults_Details) SizeVT() (n int) {
	...
	if m.EngineTraceBatch != nil {
		if size, ok := interface{}(m.EngineTraceBatch).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.EngineTraceBatch)
		}
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *TestResults_OutputFailure_Errored) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Policy) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExportConstants", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.PolicyType.(*Policy_ExportConstants); ok {
				if err := oneof.ExportConstants.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &ExportConstants{}
				...
				m.PolicyType = &Policy_ExportConstants{ExportConstants: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ExportConstants) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExportConstants: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExportConstants: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.Definitions == nil {
				m.Definitions = make(map[string]*structpb1.Value)
			}
			var mapkey string
			var mapvalue *structpb1.Value
			for iNdEx < postIndex {
...
func (m *Constants) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Constants: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Constants: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.Local == nil {
				m.Local = make(map[string]*structpb1.Value)
			}
			var mapkey string
			var mapvalue *structpb1.Value
			for iNdEx < postIndex {
...
func (m *TestFixture_Principals) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrincipalGroups", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PrincipalGroups == nil {
				m.PrincipalGroups = make(map[string]*TestFixtureGroup_Principals)
			}
			var mapkey string
			var mapvalue *TestFixtureGroup_Principals
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &TestFixtureGroup_Principals{}
			...
			m.PrincipalGroups[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.ResourceGroups == nil {
				m.ResourceGroups = make(map[string]*TestFixtureGroup_Resources)
			}
			var mapkey string
			var mapvalue *TestFixtureGroup_Resources
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &TestFixtureGroup_Resources{}
					if err := mapvalue.UnmarshalVT(dAtA[iNdEx:postmsgIndex]); err != nil {
						return err
					}
					iNdEx = postmsgIndex
...
func (m *TestFixtureGroup_Principals) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TestFixtureGroup_Principals: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TestFixtureGroup_Principals: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TestFixtureGroup_Resources) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TestFixtureGroup_Resources: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TestFixtureGroup_Resources: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TestFixtureGroup) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TestFixtureGroup: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TestFixtureGroup: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *TestTable_Input) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.PrincipalGroups = append(m.PrincipalGroups, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResourceGroups", wireType)
...
func (m *TestResults_Details) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EngineTraceBatch", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.EngineTraceBatch == nil {
				m.EngineTraceBatch = &v11.TraceBatch{}
			}
			if unmarshal, ok := interface{}(m.EngineTraceBatch).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.EngineTraceBatch); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *TestResults_OutputFailure_EvaluationError) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TestResults_OutputFailure_EvaluationError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TestResults_OutputFailure_EvaluationError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TestResults_OutputFailure) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Errored", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Outcome.(*TestResults_OutputFailure_Errored); ok {
				if err := oneof.Errored.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &TestResults_OutputFailure_EvaluationError{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Outcome = &TestResults_OutputFailure_Errored{Errored: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
