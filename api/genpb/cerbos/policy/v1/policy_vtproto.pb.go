...
func (m *PolicyPatch) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *PolicyPatch) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PolicyPatch) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if vtmsg, ok := m.PatchData.(interface {
		MarshalToSizedBufferVT([]byte) (int, error)
	}); ok {
		size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *PolicyPatch_ResourcePolicy) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PolicyPatch_ResourcePolicy) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ResourcePolicy != nil {
		size, err := m.ResourcePolicy.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *PolicyPatch_PrincipalPolicy) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PolicyPatch_PrincipalPolicy) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.PrincipalPolicy != nil {
		size, err := m.PrincipalPolicy.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *PolicyPatch_DerivedRoles) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PolicyPatch_DerivedRoles) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DerivedRoles != nil {
		size, err := m.DerivedRoles.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *PolicyPatch_ExportVariables) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PolicyPatch_ExportVariables) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ExportVariables != nil {
		size, err := m.ExportVariables.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *PolicyPatch) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if vtmsg, ok := m.PatchData.(interface{ SizeVT() int }); ok {
		n += vtmsg.SizeVT()
	}
	n += len(m.unknownFields)
	return n
...
func (m *PolicyPatch_ResourcePolicy) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PolicyPatch_PrincipalPolicy) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PolicyPatch_DerivedRoles) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PolicyPatch_ExportVariables) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PolicyPatch) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PolicyPatch: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PolicyPatch: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Operation |= PolicyPatch_Operation(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			if oneof, ok := m.PatchData.(*PolicyPatch_ResourcePolicy); ok {
				if err := oneof.ResourcePolicy.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				...
				m.PatchData = &PolicyPatch_ResourcePolicy{ResourcePolicy: v}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			if oneof, ok := m.PatchData.(*PolicyPatch_PrincipalPolicy); ok {
				if err := oneof.PrincipalPolicy.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				...
				m.PatchData = &PolicyPatch_PrincipalPolicy{PrincipalPolicy: v}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			if oneof, ok := m.PatchData.(*PolicyPatch_DerivedRoles); ok {
				if err := oneof.DerivedRoles.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				...
				m.PatchData = &PolicyPatch_DerivedRoles{DerivedRoles: v}
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			if oneof, ok := m.PatchData.(*PolicyPatch_ExportVariables); ok {
				if err := oneof.ExportVariables.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				...
				m.PatchData = &PolicyPatch_ExportVariables{ExportVariables: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
