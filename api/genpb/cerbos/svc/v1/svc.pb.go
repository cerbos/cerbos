...
var file_cerbos_svc_v1_svc_proto_rawDesc = []byte{
	...
	0x91, 0x0b, 0x0a, 0x12, 0x43, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x53,
	...
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x87, 0x01, 0x0a, 0x0e, 0x50, 0x6c,
...
var file_cerbos_svc_v1_svc_proto_goTypes = []interface{}{
	...
	(*v1.PlaygroundTestRequest)(nil),        // 13: cerbos.request.v1.PlaygroundTestRequest
	(*v1.PlaygroundEvaluateRequest)(nil),    // 14: cerbos.request.v1.PlaygroundEvaluateRequest
	(*v1.PlaygroundProxyRequest)(nil),       // 15: cerbos.request.v1.PlaygroundProxyRequest
	(*v11.CheckResourceSetResponse)(nil),    // 16: cerbos.response.v1.CheckResourceSetResponse
	(*v11.CheckResourceBatchResponse)(nil),  // 17: cerbos.response.v1.CheckResourceBatchResponse
	(*v11.ServerInfoResponse)(nil),          // 18: cerbos.response.v1.ServerInfoResponse
	(*v11.ResourcesQueryPlanResponse)(nil),  // 19: cerbos.response.v1.ResourcesQueryPlanResponse
	(*v11.AddOrUpdatePolicyResponse)(nil),   // 20: cerbos.response.v1.AddOrUpdatePolicyResponse
	(*v11.ListPoliciesResponse)(nil),        // 21: cerbos.response.v1.ListPoliciesResponse
	(*v11.GetPolicyResponse)(nil),           // 22: cerbos.response.v1.GetPolicyResponse
	(*v11.ListAuditLogEntriesResponse)(nil), // 23: cerbos.response.v1.ListAuditLogEntriesResponse
	(*v11.AddOrUpdateSchemaResponse)(nil),   // 24: cerbos.response.v1.AddOrUpdateSchemaResponse
	(*v11.ListSchemasResponse)(nil),         // 25: cerbos.response.v1.ListSchemasResponse
	(*v11.GetSchemaResponse)(nil),           // 26: cerbos.response.v1.GetSchemaResponse
	(*v11.DeleteSchemaResponse)(nil),        // 27: cerbos.response.v1.DeleteSchemaResponse
	(*v11.PlaygroundValidateResponse)(nil),  // 28: cerbos.response.v1.PlaygroundValidateResponse
	(*v11.PlaygroundTestResponse)(nil),      // 29: cerbos.response.v1.PlaygroundTestResponse
	(*v11.PlaygroundEvaluateResponse)(nil),  // 30: cerbos.response.v1.PlaygroundEvaluateResponse
	(*v11.PlaygroundProxyResponse)(nil),     // 31: cerbos.response.v1.PlaygroundProxyResponse
}
var file_cerbos_svc_v1_svc_proto_depIdxs = []int32{
	...
	13, // 13: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundTest:input_type -> cerbos.request.v1.PlaygroundTestRequest
	14, // 14: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundEvaluate:input_type -> cerbos.request.v1.PlaygroundEvaluateRequest
	15, // 15: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundProxy:input_type -> cerbos.request.v1.PlaygroundProxyRequest
	16, // 16: cerbos.svc.v1.CerbosService.CheckResourceSet:output_type -> cerbos.response.v1.CheckResourceSetResponse
	17, // 17: cerbos.svc.v1.CerbosService.CheckResourceBatch:output_type -> cerbos.response.v1.CheckResourceBatchResponse
	18, // 18: cerbos.svc.v1.CerbosService.ServerInfo:output_type -> cerbos.response.v1.ServerInfoResponse
	19, // 19: cerbos.svc.v1.CerbosService.ResourcesQueryPlan:output_type -> cerbos.response.v1.ResourcesQueryPlanResponse
	20, // 20: cerbos.svc.v1.CerbosAdminService.AddOrUpdatePolicy:output_type -> cerbos.response.v1.AddOrUpdatePolicyResponse
	21, // 21: cerbos.svc.v1.CerbosAdminService.ListPolicies:output_type -> cerbos.response.v1.ListPoliciesResponse
	22, // 22: cerbos.svc.v1.CerbosAdminService.GetPolicy:output_type -> cerbos.response.v1.GetPolicyResponse
	23, // 23: cerbos.svc.v1.CerbosAdminService.ListAuditLogEntries:output_type -> cerbos.response.v1.ListAuditLogEntriesResponse
	24, // 24: cerbos.svc.v1.CerbosAdminService.AddOrUpdateSchema:output_type -> cerbos.response.v1.AddOrUpdateSchemaResponse
	25, // 25: cerbos.svc.v1.CerbosAdminService.ListSchemas:output_type -> cerbos.response.v1.ListSchemasResponse
	26, // 26: cerbos.svc.v1.CerbosAdminService.GetSchema:output_type -> cerbos.response.v1.GetSchemaResponse
	27, // 27: cerbos.svc.v1.CerbosAdminService.DeleteSchema:output_type -> cerbos.response.v1.DeleteSchemaResponse
	28, // 28: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundValidate:output_type -> cerbos.response.v1.PlaygroundValidateResponse
	29, // 29: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundTest:output_type -> cerbos.response.v1.PlaygroundTestResponse
	30, // 30: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundEvaluate:output_type -> cerbos.response.v1.PlaygroundEvaluateResponse
	31, // 31: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundProxy:output_type -> cerbos.response.v1.PlaygroundProxyResponse
