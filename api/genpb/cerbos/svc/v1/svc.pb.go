...
var file_cerbos_svc_v1_svc_proto_rawDesc = []byte{
	...
	0x65, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x42, 0xe1, 0x01, 0x0a, 0x15,
...
var file_cerbos_svc_v1_svc_proto_goTypes = []interface{}{
	...
	(*v11.ServerInfoResponse)(nil),          // 9: cerbos.response.v1.ServerInfoResponse
	(*v11.AddOrUpdatePolicyResponse)(nil),   // 10: cerbos.response.v1.AddOrUpdatePolicyResponse
	(*v11.ListAuditLogEntriesResponse)(nil), // 11: cerbos.response.v1.ListAuditLogEntriesResponse
...
var file_cerbos_svc_v1_svc_proto_depIdxs = []int32{
	...
	9,  // 9: cerbos.svc.v1.CerbosService.ServerInfo:output_type -> cerbos.response.v1.ServerInfoResponse
	10, // 10: cerbos.svc.v1.CerbosAdminService.AddOrUpdatePolicy:output_type -> cerbos.response.v1.AddOrUpdatePolicyResponse
	11, // 11: cerbos.svc.v1.CerbosAdminService.ListAuditLogEntries:output_type -> cerbos.response.v1.ListAuditLogEntriesResponse
