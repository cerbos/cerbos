...
var file_cerbos_svc_v1_svc_proto_rawDesc = []byte{
	...
	0x9c, 0x0a, 0x0a, 0x12, 0x43, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x53,
	...
	0x01, 0x2a, 0x12, 0xc8, 0x01, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x75, 0x64, 0x69, 0x74,
	...
	0x6c, 0x69, 0x73, 0x74, 0x2f, 0x7b, 0x6b, 0x69, 0x6e, 0x64, 0x7d, 0x30, 0x01, 0x12, 0xb8, 0x01,
	...
	0x22, 0x56, 0x92, 0x41, 0x20, 0x12, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x20, 0x70, 0x6f, 0x6c, 0x69,
	0x63, 0x69, 0x65, 0x73, 0x62, 0x0f, 0x0a, 0x0d, 0x0a, 0x09, 0x42, 0x61, 0x73, 0x69, 0x63, 0x41,
	0x75, 0x74, 0x68, 0x12, 0x00, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2d, 0x12, 0x12, 0x2f, 0x61, 0x64,
	0x6d, 0x69, 0x6e, 0x2f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x5a,
	0x17, 0x22, 0x12, 0x2f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	0x2f, 0x6c, 0x69, 0x73, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0xc7, 0x01, 0x0a, 0x11, 0x41, 0x64, 0x64,
	...
	,
...
var file_cerbos_svc_v1_svc_proto_goTypes = []interface{}{
	...
	(*v1.AddOrUpdateSchemaRequest)(nil),     // 7: cerbos.request.v1.AddOrUpdateSchemaRequest
	(*v1.ListSchemasRequest)(nil),           // 8: cerbos.request.v1.ListSchemasRequest
	(*v1.GetSchemaRequest)(nil),             // 9: cerbos.request.v1.GetSchemaRequest
	(*v1.DeleteSchemaRequest)(nil),          // 10: cerbos.request.v1.DeleteSchemaRequest
	(*v1.PlaygroundValidateRequest)(nil),    // 11: cerbos.request.v1.PlaygroundValidateRequest
	(*v1.PlaygroundEvaluateRequest)(nil),    // 12: cerbos.request.v1.PlaygroundEvaluateRequest
	(*v1.PlaygroundProxyRequest)(nil),       // 13: cerbos.request.v1.PlaygroundProxyRequest
	(*v11.CheckResourceSetResponse)(nil),    // 14: cerbos.response.v1.CheckResourceSetResponse
	(*v11.CheckResourceBatchResponse)(nil),  // 15: cerbos.response.v1.CheckResourceBatchResponse
	(*v11.ServerInfoResponse)(nil),          // 16: cerbos.response.v1.ServerInfoResponse
	(*v11.ResourcesQueryPlanResponse)(nil),  // 17: cerbos.response.v1.ResourcesQueryPlanResponse
	(*v11.AddOrUpdatePolicyResponse)(nil),   // 18: cerbos.response.v1.AddOrUpdatePolicyResponse
	(*v11.ListAuditLogEntriesResponse)(nil), // 19: cerbos.response.v1.ListAuditLogEntriesResponse
	(*v11.ListPoliciesResponse)(nil),        // 20: cerbos.response.v1.ListPoliciesResponse
	(*v11.AddOrUpdateSchemaResponse)(nil),   // 21: cerbos.response.v1.AddOrUpdateSchemaResponse
	(*v11.ListSchemasResponse)(nil),         // 22: cerbos.response.v1.ListSchemasResponse
	(*v11.GetSchemaResponse)(nil),           // 23: cerbos.response.v1.GetSchemaResponse
	(*v11.DeleteSchemaResponse)(nil),        // 24: cerbos.response.v1.DeleteSchemaResponse
	(*v11.PlaygroundValidateResponse)(nil),  // 25: cerbos.response.v1.PlaygroundValidateResponse
	(*v11.PlaygroundEvaluateResponse)(nil),  // 26: cerbos.response.v1.PlaygroundEvaluateResponse
	(*v11.PlaygroundProxyResponse)(nil),     // 27: cerbos.response.v1.PlaygroundProxyResponse
}
var file_cerbos_svc_v1_svc_proto_depIdxs = []int32{
	...
	7,  // 7: cerbos.svc.v1.CerbosAdminService.AddOrUpdateSchema:input_type -> cerbos.request.v1.AddOrUpdateSchemaRequest
	8,  // 8: cerbos.svc.v1.CerbosAdminService.ListSchemas:input_type -> cerbos.request.v1.ListSchemasRequest
	9,  // 9: cerbos.svc.v1.CerbosAdminService.GetSchema:input_type -> cerbos.request.v1.GetSchemaRequest
	10, // 10: cerbos.svc.v1.CerbosAdminService.DeleteSchema:input_type -> cerbos.request.v1.DeleteSchemaRequest
	11, // 11: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundValidate:input_type -> cerbos.request.v1.PlaygroundValidateRequest
	12, // 12: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundEvaluate:input_type -> cerbos.request.v1.PlaygroundEvaluateRequest
	13, // 13: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundProxy:input_type -> cerbos.request.v1.PlaygroundProxyRequest
	14, // 14: cerbos.svc.v1.CerbosService.CheckResourceSet:output_type -> cerbos.response.v1.CheckResourceSetResponse
	15, // 15: cerbos.svc.v1.CerbosService.CheckResourceBatch:output_type -> cerbos.response.v1.CheckResourceBatchResponse
	16, // 16: cerbos.svc.v1.CerbosService.ServerInfo:output_type -> cerbos.response.v1.ServerInfoResponse
	17, // 17: cerbos.svc.v1.CerbosService.ResourcesQueryPlan:output_type -> cerbos.response.v1.ResourcesQueryPlanResponse
	18, // 18: cerbos.svc.v1.CerbosAdminService.AddOrUpdatePolicy:output_type -> cerbos.response.v1.AddOrUpdatePolicyResponse
	19, // 19: cerbos.svc.v1.CerbosAdminService.ListAuditLogEntries:output_type -> cerbos.response.v1.ListAuditLogEntriesResponse
	20, // 20: cerbos.svc.v1.CerbosAdminService.ListPolicies:output_type -> cerbos.response.v1.ListPoliciesResponse
	21, // 21: cerbos.svc.v1.CerbosAdminService.AddOrUpdateSchema:output_type -> cerbos.response.v1.AddOrUpdateSchemaResponse
	22, // 22: cerbos.svc.v1.CerbosAdminService.ListSchemas:output_type -> cerbos.response.v1.ListSchemasResponse
	23, // 23: cerbos.svc.v1.CerbosAdminService.GetSchema:output_type -> cerbos.response.v1.GetSchemaResponse
	24, // 24: cerbos.svc.v1.CerbosAdminService.DeleteSchema:output_type -> cerbos.response.v1.DeleteSchemaResponse
	25, // 25: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundValidate:output_type -> cerbos.response.v1.PlaygroundValidateResponse
	26, // 26: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundEvaluate:output_type -> cerbos.response.v1.PlaygroundEvaluateResponse
	27, // 27: cerbos.svc.v1.CerbosPlaygroundService.PlaygroundProxy:output_type -> cerbos.response.v1.PlaygroundProxyResponse
