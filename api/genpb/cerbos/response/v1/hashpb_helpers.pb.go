...
func cerbos_engine_v1_EvaluationError_CELError_hashpb_sum(m *v11.EvaluationError_CELError, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
...
func cerbos_engine_v1_EvaluationError_hashpb_sum(m *v11.EvaluationError, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if m.Error != nil {
		if _, ok := ignore["cerbos.engine.v1.EvaluationError.error"]; !ok {
			switch t := m.Error.(type) {
			case *v11.EvaluationError_CelError:
				if t.CelError != nil {
...
func cerbos_policy_v1_TestResults_OutputFailure_hashpb_sum(m *v12.TestResults_OutputFailure, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.Outcome != nil {
		if _, ok := ignore["cerbos.policy.v1.TestResults.OutputFailure.outcome"]; !ok {
			...
			case *v12.TestResults_OutputFailure_Errored:
				if t.Errored != nil {
