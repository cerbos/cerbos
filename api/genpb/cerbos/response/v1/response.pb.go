...
var file_cerbos_response_v1_response_proto_rawDesc = []byte{
	...
	0x61, 0x28, 0x73, 0x29, 0x20, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x77, 0x0a,
...
var file_cerbos_response_v1_response_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_cerbos_response_v1_response_proto_goTypes = []interface{}{
	...
	(*AddOrUpdateSchemaResponse)(nil),                     // 11: cerbos.response.v1.AddOrUpdateSchemaResponse
	(*ListSchemasResponse)(nil),                           // 12: cerbos.response.v1.ListSchemasResponse
	(*GetSchemaResponse)(nil),                             // 13: cerbos.response.v1.GetSchemaResponse
	(*DeleteSchemaResponse)(nil),                          // 14: cerbos.response.v1.DeleteSchemaResponse
	(*ResourcesQueryPlanResponse_Expression)(nil),         // 15: cerbos.response.v1.ResourcesQueryPlanResponse.Expression
	(*ResourcesQueryPlanResponse_Meta)(nil),               // 16: cerbos.response.v1.ResourcesQueryPlanResponse.Meta
	(*ResourcesQueryPlanResponse_Expression_Operand)(nil), // 17: cerbos.response.v1.ResourcesQueryPlanResponse.Expression.Operand
	(*CheckResourceSetResponse_ActionEffectMap)(nil),      // 18: cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap
	(*CheckResourceSetResponse_Meta)(nil),                 // 19: cerbos.response.v1.CheckResourceSetResponse.Meta
	nil,                                                   // 20: cerbos.response.v1.CheckResourceSetResponse.ResourceInstancesEntry
	nil,                                                   // 21: cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap.ActionsEntry
	(*CheckResourceSetResponse_Meta_EffectMeta)(nil),      // 22: cerbos.response.v1.CheckResourceSetResponse.Meta.EffectMeta
	(*CheckResourceSetResponse_Meta_ActionMeta)(nil),      // 23: cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta
	nil, // 24: cerbos.response.v1.CheckResourceSetResponse.Meta.ResourceInstancesEntry
	nil, // 25: cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta.ActionsEntry
	(*CheckResourceBatchResponse_ActionEffectMap)(nil), // 26: cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap
	nil,                             // 27: cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap.ActionsEntry
	(*PlaygroundFailure_Error)(nil), // 28: cerbos.response.v1.PlaygroundFailure.Error
	(*PlaygroundEvaluateResponse_EvalResult)(nil),     // 29: cerbos.response.v1.PlaygroundEvaluateResponse.EvalResult
	(*PlaygroundEvaluateResponse_EvalResultList)(nil), // 30: cerbos.response.v1.PlaygroundEvaluateResponse.EvalResultList
	(*emptypb.Empty)(nil),                             // 31: google.protobuf.Empty
	(*v1.AccessLogEntry)(nil),                         // 32: cerbos.audit.v1.AccessLogEntry
	(*v1.DecisionLogEntry)(nil),                       // 33: cerbos.audit.v1.DecisionLogEntry
	...
	(*v12.ValidationError)(nil),                       // 37: cerbos.schema.v1.ValidationError
	(v13.Effect)(0),                                   // 38: cerbos.effect.v1.Effect
}
var file_cerbos_response_v1_response_proto_depIdxs = []int32{
	17, // 0: cerbos.response.v1.ResourcesQueryPlanResponse.filter:type_name -> cerbos.response.v1.ResourcesQueryPlanResponse.Expression.Operand
	16, // 1: cerbos.response.v1.ResourcesQueryPlanResponse.meta:type_name -> cerbos.response.v1.ResourcesQueryPlanResponse.Meta
	20, // 2: cerbos.response.v1.CheckResourceSetResponse.resource_instances:type_name -> cerbos.response.v1.CheckResourceSetResponse.ResourceInstancesEntry
	19, // 3: cerbos.response.v1.CheckResourceSetResponse.meta:type_name -> cerbos.response.v1.CheckResourceSetResponse.Meta
	26, // 4: cerbos.response.v1.CheckResourceBatchResponse.results:type_name -> cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap
	28, // 5: cerbos.response.v1.PlaygroundFailure.errors:type_name -> cerbos.response.v1.PlaygroundFailure.Error
	3,  // 6: cerbos.response.v1.PlaygroundValidateResponse.failure:type_name -> cerbos.response.v1.PlaygroundFailure
	31, // 7: cerbos.response.v1.PlaygroundValidateResponse.success:type_name -> google.protobuf.Empty
	3,  // 8: cerbos.response.v1.PlaygroundEvaluateResponse.failure:type_name -> cerbos.response.v1.PlaygroundFailure
	30, // 9: cerbos.response.v1.PlaygroundEvaluateResponse.success:type_name -> cerbos.response.v1.PlaygroundEvaluateResponse.EvalResultList
	...
	31, // 13: cerbos.response.v1.AddOrUpdatePolicyResponse.success:type_name -> google.protobuf.Empty
	32, // 14: cerbos.response.v1.ListAuditLogEntriesResponse.access_log_entry:type_name -> cerbos.audit.v1.AccessLogEntry
	33, // 15: cerbos.response.v1.ListAuditLogEntriesResponse.decision_log_entry:type_name -> cerbos.audit.v1.DecisionLogEntry
	34, // 16: cerbos.response.v1.ListPoliciesResponse.policies:type_name -> cerbos.policy.v1.Policy
	35, // 17: cerbos.response.v1.GetSchemaResponse.schemas:type_name -> cerbos.schema.v1.Schema
	17, // 18: cerbos.response.v1.ResourcesQueryPlanResponse.Expression.operands:type_name -> cerbos.response.v1.ResourcesQueryPlanResponse.Expression.Operand
	36, // 19: cerbos.response.v1.ResourcesQueryPlanResponse.Expression.Operand.value:type_name -> google.protobuf.Value
	15, // 20: cerbos.response.v1.ResourcesQueryPlanResponse.Expression.Operand.expression:type_name -> cerbos.response.v1.ResourcesQueryPlanResponse.Expression
	21, // 21: cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap.actions:type_name -> cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap.ActionsEntry
	37, // 22: cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap.validation_errors:type_name -> cerbos.schema.v1.ValidationError
	24, // 23: cerbos.response.v1.CheckResourceSetResponse.Meta.resource_instances:type_name -> cerbos.response.v1.CheckResourceSetResponse.Meta.ResourceInstancesEntry
	18, // 24: cerbos.response.v1.CheckResourceSetResponse.ResourceInstancesEntry.value:type_name -> cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap
	38, // 25: cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap.ActionsEntry.value:type_name -> cerbos.effect.v1.Effect
	25, // 26: cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta.actions:type_name -> cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta.ActionsEntry
	23, // 27: cerbos.response.v1.CheckResourceSetResponse.Meta.ResourceInstancesEntry.value:type_name -> cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta
	22, // 28: cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta.ActionsEntry.value:type_name -> cerbos.response.v1.CheckResourceSetResponse.Meta.EffectMeta
	27, // 29: cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap.actions:type_name -> cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap.ActionsEntry
	37, // 30: cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap.validation_errors:type_name -> cerbos.schema.v1.ValidationError
	38, // 31: cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap.ActionsEntry.value:type_name -> cerbos.effect.v1.Effect
	38, // 32: cerbos.response.v1.PlaygroundEvaluateResponse.EvalResult.effect:type_name -> cerbos.effect.v1.Effect
	37, // 33: cerbos.response.v1.PlaygroundEvaluateResponse.EvalResult.validation_errors:type_name -> cerbos.schema.v1.ValidationError
	29, // 34: cerbos.response.v1.PlaygroundEvaluateResponse.EvalResultList.results:type_name -> cerbos.response.v1.PlaygroundEvaluateResponse.EvalResult
...
func file_cerbos_response_v1_response_proto_init() {
	...
	file_cerbos_response_v1_response_proto_msgTypes[17].OneofWrappers = []interface{}{
