...
func (x *AddOrUpdateSchemaResponse) GetSuccess() *emptypb.Empty {
	if x != nil {
		return x.Success
	}
	return nil
...
var file_cerbos_response_v1_response_proto_rawDesc = []byte{
	...
	0x72, 0x76, 0x65, 0x72, 0x22, 0x70, 0x0a, 0x19, 0x41, 0x64, 0x64, 0x4f, 0x72, 0x55, 0x70, 0x64,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x7d, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x63,
	...
	0x73, 0x3a, 0x32, 0x92, 0x41, 0x2f, 0x0a, 0x2d, 0x32, 0x2b, 0x4c, 0x69, 0x73, 0x74, 0x20, 0x6f,
	0x66, 0x20, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x20, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x64,
...
var file_cerbos_response_v1_response_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_cerbos_response_v1_response_proto_goTypes = []interface{}{
	...
	(*CheckResourceSetResponse_ActionEffectMap)(nil), // 12: cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap
	(*CheckResourceSetResponse_Meta)(nil),            // 13: cerbos.response.v1.CheckResourceSetResponse.Meta
	nil,                                              // 14: cerbos.response.v1.CheckResourceSetResponse.ResourceInstancesEntry
	nil,                                              // 15: cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap.ActionsEntry
	(*CheckResourceSetResponse_Meta_EffectMeta)(nil), // 16: cerbos.response.v1.CheckResourceSetResponse.Meta.EffectMeta
	(*CheckResourceSetResponse_Meta_ActionMeta)(nil), // 17: cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta
	nil, // 18: cerbos.response.v1.CheckResourceSetResponse.Meta.ResourceInstancesEntry
	nil, // 19: cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta.ActionsEntry
	(*CheckResourceBatchResponse_ActionEffectMap)(nil), // 20: cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap
	nil,                             // 21: cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap.ActionsEntry
	(*PlaygroundFailure_Error)(nil), // 22: cerbos.response.v1.PlaygroundFailure.Error
	(*PlaygroundEvaluateResponse_EvalResult)(nil),     // 23: cerbos.response.v1.PlaygroundEvaluateResponse.EvalResult
	(*PlaygroundEvaluateResponse_EvalResultList)(nil), // 24: cerbos.response.v1.PlaygroundEvaluateResponse.EvalResultList
	(*emptypb.Empty)(nil),                             // 25: google.protobuf.Empty
	(*v1.AccessLogEntry)(nil),                         // 26: cerbos.audit.v1.AccessLogEntry
	(*v1.DecisionLogEntry)(nil),                       // 27: cerbos.audit.v1.DecisionLogEntry
	(*v11.Policy)(nil),                                // 28: cerbos.policy.v1.Policy
	(*v12.Schema)(nil),                                // 29: cerbos.schema.v1.Schema
	(v13.Effect)(0),                                   // 30: cerbos.effect.v1.Effect
}
var file_cerbos_response_v1_response_proto_depIdxs = []int32{
	14, // 0: cerbos.response.v1.CheckResourceSetResponse.resource_instances:type_name -> cerbos.response.v1.CheckResourceSetResponse.ResourceInstancesEntry
	13, // 1: cerbos.response.v1.CheckResourceSetResponse.meta:type_name -> cerbos.response.v1.CheckResourceSetResponse.Meta
	20, // 2: cerbos.response.v1.CheckResourceBatchResponse.results:type_name -> cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap
	22, // 3: cerbos.response.v1.PlaygroundFailure.errors:type_name -> cerbos.response.v1.PlaygroundFailure.Error
	2,  // 4: cerbos.response.v1.PlaygroundValidateResponse.failure:type_name -> cerbos.response.v1.PlaygroundFailure
	25, // 5: cerbos.response.v1.PlaygroundValidateResponse.success:type_name -> google.protobuf.Empty
	2,  // 6: cerbos.response.v1.PlaygroundEvaluateResponse.failure:type_name -> cerbos.response.v1.PlaygroundFailure
	24, // 7: cerbos.response.v1.PlaygroundEvaluateResponse.success:type_name -> cerbos.response.v1.PlaygroundEvaluateResponse.EvalResultList
	...
	25, // 11: cerbos.response.v1.AddOrUpdatePolicyResponse.success:type_name -> google.protobuf.Empty
	26, // 12: cerbos.response.v1.ListAuditLogEntriesResponse.access_log_entry:type_name -> cerbos.audit.v1.AccessLogEntry
	27, // 13: cerbos.response.v1.ListAuditLogEntriesResponse.decision_log_entry:type_name -> cerbos.audit.v1.DecisionLogEntry
	28, // 14: cerbos.response.v1.ListPoliciesResponse.policies:type_name -> cerbos.policy.v1.Policy
	25, // 15: cerbos.response.v1.AddOrUpdateSchemaResponse.success:type_name -> google.protobuf.Empty
	29, // 16: cerbos.response.v1.ListSchemasResponse.schemas:type_name -> cerbos.schema.v1.Schema
	15, // 17: cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap.actions:type_name -> cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap.ActionsEntry
	18, // 18: cerbos.response.v1.CheckResourceSetResponse.Meta.resource_instances:type_name -> cerbos.response.v1.CheckResourceSetResponse.Meta.ResourceInstancesEntry
	12, // 19: cerbos.response.v1.CheckResourceSetResponse.ResourceInstancesEntry.value:type_name -> cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap
	30, // 20: cerbos.response.v1.CheckResourceSetResponse.ActionEffectMap.ActionsEntry.value:type_name -> cerbos.effect.v1.Effect
	19, // 21: cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta.actions:type_name -> cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta.ActionsEntry
	17, // 22: cerbos.response.v1.CheckResourceSetResponse.Meta.ResourceInstancesEntry.value:type_name -> cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta
	16, // 23: cerbos.response.v1.CheckResourceSetResponse.Meta.ActionMeta.ActionsEntry.value:type_name -> cerbos.response.v1.CheckResourceSetResponse.Meta.EffectMeta
	21, // 24: cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap.actions:type_name -> cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap.ActionsEntry
	30, // 25: cerbos.response.v1.CheckResourceBatchResponse.ActionEffectMap.ActionsEntry.value:type_name -> cerbos.effect.v1.Effect
	30, // 26: cerbos.response.v1.PlaygroundEvaluateResponse.EvalResult.effect:type_name -> cerbos.effect.v1.Effect
	23, // 27: cerbos.response.v1.PlaygroundEvaluateResponse.EvalResultList.results:type_name -> cerbos.response.v1.PlaygroundEvaluateResponse.EvalResult
