...
const file_cerbos_response_v1_response_proto_rawDesc = "" +
	...
	"\x06action\x18\x02 \x01(\tB\x1a\x92A\x172\x06ActionJ\r\"view:public\"R\x06action\x12H\n" +
	...
	"\x0ecerbos_call_id\x18\b \x01(\tB3\x92A02.Audit log call ID associated with this requestR\fcerbosCallId\x1a\xff\x01\n" +
	"\x04Meta\x12]\n" +
	"\ffilter_debug\x18\x01 \x01(\tB:\x92A725Filter textual representation for debugging purposes.R\vfilterDebug\x12m\n" +
	"\rmatched_scope\x18\x02 \x01(\tBH\x92AE21Policy scope that matched to produce this effect.J\x10\"acme.corp.base\"R\fmatchedScope:)\x92A&\n" +
	...
	"\x0ecerbos_call_id\x18\x03 \x01(\tB3\x92A02.Audit log call ID associated with this requestR\fcerbosCallId\x1a\xbd\x13\n" +
	"\vResultEntry\x12[\n" +
	...
	"\aoutputs\x18\x05 \x03(\v2\x1d.cerbos.engine.v1.OutputEntryB\xbc\x01\x92A\xb8\x012,Output for each rule with outputs configuredJ\x87\x01[{\"src\": \"resource.expense.v1/acme#rule-001\", \"val\": \"view_allowed:alice\"}, {\"src\": \"resource.expense.v1/acme#rule-002\", \"val\": \"foo\"}]R\aoutputs\x1a\xbc\x04\n" +
	"\bResource\x129\n" +
	"\x02id\x18\x01 \x01(\tB)\x92A&2\x1bID of the resource instanceJ\a\"XX125\"R\x02id\x12Q\n" +
	"\x04kind\x18\x02 \x01(\tB=\x92A:2)Name of the resource kind being accessed.J\r\"album:photo\"R\x04kind\x12\xc5\x01\n" +
	"\x0epolicy_version\x18\x03 \x01(\tB\x9d\x01\x92A\x99\x012|The policy version to use to evaluate this request. If not specified, will default to the server-configured default version.J\t\"default\"\x8a\x01\r^[[:word:]]*$R\rpolicyVersion\x12\xd9\x01\n" +
	"\x05scope\x18\x04 \x01(\tB\xc2\x01\x92A\xbe\x012}A dot-separated scope that describes the hierarchy this resource belongs to. This is used for determining policy inheritance.J\v\"acme.corp\"\x8a\x01/^([[:alnum:]][[:word:]\\-]*(\\.[[:word:]\\-]*)*)*$R\x05scope\x1a\xf0\x06\n" +
	"\x04Meta\x12\xa6\x02\n" +
