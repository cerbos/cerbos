...
func (m *PlanResourcesResponse_Meta) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.MatchedScopes) > 0 {
		for iNdEx := len(m.MatchedScopes) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.MatchedScopes[iNdEx])
			copy(dAtA[i:], m.MatchedScopes[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.MatchedScopes[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *CrossScopePlanResourcesResponse_Meta) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CrossScopePlanResourcesResponse_Meta) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *CrossScopePlanResourcesResponse_Meta) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *CrossScopePlanResourcesResponse) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CrossScopePlanResourcesResponse) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *CrossScopePlanResourcesResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *CrossScopePlanResourcesResponse_Meta) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CrossScopePlanResourcesResponse) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PlanResourcesResponse_Meta) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.MatchedScopes = append(m.MatchedScopes, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *CrossScopePlanResourcesResponse_Meta) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CrossScopePlanResourcesResponse_Meta: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CrossScopePlanResourcesResponse_Meta: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScopesMeta", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ScopesMeta == nil {
				m.ScopesMeta = make(map[string]*PlanResourcesResponse_Meta)
			}
			var mapkey string
			var mapvalue *PlanResourcesResponse_Meta
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &PlanResourcesResponse_Meta{}
...
func (m *CrossScopePlanResourcesResponse) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CrossScopePlanResourcesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CrossScopePlanResourcesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 6:
			...
			if m.Meta == nil {
				m.Meta = &CrossScopePlanResourcesResponse_Meta{}
			}
			if err := m.Meta.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
