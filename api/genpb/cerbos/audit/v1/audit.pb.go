...
var file_cerbos_audit_v1_audit_proto_rawDesc = string([]byte{
...
func file_cerbos_audit_v1_audit_proto_rawDescGZIP() []byte {
	file_cerbos_audit_v1_audit_proto_rawDescOnce.Do(func() {
		file_cerbos_audit_v1_audit_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_cerbos_audit_v1_audit_proto_rawDescData)))
	})
	return []byte(file_cerbos_audit_v1_audit_proto_rawDescData)
}
