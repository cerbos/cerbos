...
func cerbos_audit_v1_PolicySource_EmbeddedPDP_hashpb_sum(m *PolicySource_EmbeddedPDP, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_audit_v1_RequestContext_hashpb_sum(m *RequestContext, hasher hash.Hash, ignore map[string]struct{}) {
