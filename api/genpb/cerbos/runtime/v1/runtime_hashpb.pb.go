...
// HashPB computes a hash of the message using the given hash function
// The ignore set must contain fully-qualified field names (pkg.msg.field) that should be ignored from the hash
func (m *RuleTableConf) HashPB(hasher hash.Hash, ignore map[string]struct{}) {
	if m != nil {
		cerbos_runtime_v1_RuleTableConf_hashpb_sum(m, hasher, ignore)
	}
}

// HashPB computes a hash of the message using the given hash function
// The ignore set must contain fully-qualified field names (pkg.msg.field) that should be ignored from the hash
func (m *RuleTableConf_EvaluatorConf) HashPB(hasher hash.Hash, ignore map[string]struct{}) {
	if m != nil {
		cerbos_runtime_v1_RuleTableConf_EvaluatorConf_hashpb_sum(m, hasher, ignore)
	}
}

// HashPB computes a hash of the message using the given hash function
// The ignore set must contain fully-qualified field names (pkg.msg.field) that should be ignored from the hash
func (m *RuleTableConf_SchemaConf) HashPB(hasher hash.Hash, ignore map[string]struct{}) {
	if m != nil {
		cerbos_runtime_v1_RuleTableConf_SchemaConf_hashpb_sum(m, hasher, ignore)
	}
}
...
func (m *RuleTable_RuleRow_Params) HashPB(hasher hash.Hash, ignore map[string]struct{}) {
	if m != nil {
		cerbos_runtime_v1_RuleTable_RuleRow_Params_hashpb_sum(m, hasher, ignore)
	}
}
