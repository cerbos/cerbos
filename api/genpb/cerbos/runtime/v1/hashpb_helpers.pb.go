...
func cerbos_runtime_v1_IndexBuildErrors_ScopePermissionsConflicts_Policy_hashpb_sum(m *IndexBuildErrors_ScopePermissionsConflicts_Policy, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
