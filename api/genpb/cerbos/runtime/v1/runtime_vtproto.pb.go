...
func (m *RuleTable_RuleRow) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PolicyKind != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.PolicyKind))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x98
	...
	if m.DerivedRoleParams != nil {
		size, err := m.DerivedRoleParams.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *IndexBuildErrors_ScopePermissionsConflicts_Policy) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *IndexBuildErrors_ScopePermissionsConflicts_Policy) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *IndexBuildErrors_ScopePermissionsConflicts_Policy) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *BitmapIndex_GlobDimension) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Globs) > 0 {
		for iNdEx := len(m.Globs) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.Globs[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.Literals) > 0 {
		for iNdEx := len(m.Literals) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.Literals[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *BitmapIndex_Binding) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.CoreIndex != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.CoreIndex))
		i--
		dAtA[i] = 0x10
	}
	if m.Id != 0 {
...
func (m *BitmapIndex) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Cores) > 0 {
		for iNdEx := len(m.Cores) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.Cores[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.AllowActionsBitmap) > 0 {
		i -= len(m.AllowActionsBitmap)
		copy(dAtA[i:], m.AllowActionsBitmap)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AllowActionsBitmap)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.Universe) > 0 {
		i -= len(m.Universe)
		copy(dAtA[i:], m.Universe)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Universe)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Principal) > 0 {
		for iNdEx := len(m.Principal) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.Principal[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.Version) > 0 {
		for iNdEx := len(m.Version) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.Version[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RuleTable_RuleRow_Params) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RuleTable_RuleRow) SizeVT() (n int) {
	...
	if m.PolicyKind != 0 {
		n += 2 + protohelpers.SizeOfVarint(uint64(m.PolicyKind))
	}
	if m.FromRolePolicy {
		n += 3
	}
...
func (m *RuleTable_RoleParentRoles) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.RoleParentRoles) > 0 {
		for k, v := range m.RoleParentRoles {
			_ = k
			_ = v
			l = 0
			if v != nil {
...
func (m *RuleTable_PolicyDerivedRoles) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RuleTable_Manifest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RuleTable) SizeVT() (n int) {
	...
	if len(m.ScopeParentRoles) > 0 {
		for k, v := range m.ScopeParentRoles {
			_ = k
			_ = v
			l = 0
			if v != nil {
	...
	if len(m.PolicyDerivedRoles) > 0 {
		for k, v := range m.PolicyDerivedRoles {
			_ = k
			_ = v
			l = 0
			if v != nil {
...
func (m *IndexBuildErrors_ScopePermissionsConflicts_Policy) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BitmapIndex_Entry) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BitmapIndex_GlobDimension) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BitmapIndex_AllowActions) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BitmapIndex_Binding) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.CoreIndex != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.CoreIndex))
	}
	l = len(m.Role)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
...
func (m *BitmapIndex_Binding_Action) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BitmapIndex_Binding_AllowActions) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BitmapIndex_FunctionalCore) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.PolicyKind != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.PolicyKind))
	}
	if m.FromRolePolicy {
		n += 2
	}
...
func (m *BitmapIndex_Parents) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BitmapIndex_RoleParents) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BitmapIndex) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RuleTable_RuleRow_Params) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RuleTable_RuleRow_Params: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RuleTable_RuleRow_Params: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RuleTable_RuleRow) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			...
			if m.Params == nil {
				m.Params = &RuleTable_RuleRow_Params{}
			}
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DerivedRoleParams", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DerivedRoleParams == nil {
				m.DerivedRoleParams = &RuleTable_RuleRow_Params{}
			}
			if err := m.DerivedRoleParams.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 18:
		...
		case 19:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PolicyKind", wireType)
			}
			m.PolicyKind = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PolicyKind |= v11.Kind(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FromRolePolicy", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *RuleTable_RoleParentRoles_ParentRoles) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RuleTable_RoleParentRoles_ParentRoles: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RuleTable_RoleParentRoles_ParentRoles: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RuleTable_RoleParentRoles) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RuleTable_RoleParentRoles: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RuleTable_RoleParentRoles: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RoleParentRoles", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RoleParentRoles == nil {
				m.RoleParentRoles = make(map[string]*RuleTable_RoleParentRoles_ParentRoles)
			}
			var mapkey string
			var mapvalue *RuleTable_RoleParentRoles_ParentRoles
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &RuleTable_RoleParentRoles_ParentRoles{}
			...
			m.RoleParentRoles[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *RuleTable_PolicyDerivedRoles) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RuleTable_PolicyDerivedRoles: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RuleTable_PolicyDerivedRoles: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RuleTable_Manifest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RuleTable_Manifest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RuleTable_Manifest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RuleTable) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Schemas == nil {
				m.Schemas = make(map[uint64]*v11.Schemas)
			}
			var mapkey uint64
			var mapvalue *v11.Schemas
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 3:
			...
			if m.Meta == nil {
				m.Meta = make(map[uint64]*RuleTableMetadata)
			}
			var mapkey uint64
			var mapvalue *RuleTableMetadata
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScopeParentRoles", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ScopeParentRoles == nil {
				m.ScopeParentRoles = make(map[string]*RuleTable_RoleParentRoles)
			}
			var mapkey string
			var mapvalue *RuleTable_RoleParentRoles
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &RuleTable_RoleParentRoles{}
					if err := mapvalue.UnmarshalVT(dAtA[iNdEx:postmsgIndex]); err != nil {
						return err
					}
					iNdEx = postmsgIndex
			...
			m.ScopeParentRoles[mapkey] = mapvalue
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PolicyDerivedRoles", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PolicyDerivedRoles == nil {
				m.PolicyDerivedRoles = make(map[uint64]*RuleTable_PolicyDerivedRoles)
			}
			var mapkey uint64
			var mapvalue *RuleTable_PolicyDerivedRoles
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &RuleTable_PolicyDerivedRoles{}
					if err := mapvalue.UnmarshalVT(dAtA[iNdEx:postmsgIndex]); err != nil {
						return err
					}
					iNdEx = postmsgIndex
...
func (m *IndexBuildErrors_ScopePermissionsConflicts_Policy) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IndexBuildErrors_ScopePermissionsConflicts_Policy: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IndexBuildErrors_ScopePermissionsConflicts_Policy: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *IndexBuildErrors_ScopePermissionsConflicts) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Policies = append(m.Policies, &IndexBuildErrors_ScopePermissionsConflicts_Policy{})
			if err := m.Policies[len(m.Policies)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *BitmapIndex_Entry) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BitmapIndex_Entry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BitmapIndex_Entry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *BitmapIndex_GlobDimension) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BitmapIndex_GlobDimension: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BitmapIndex_GlobDimension: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Literals = append(m.Literals, &BitmapIndex_Entry{})
			if err := m.Literals[len(m.Literals)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			m.Globs = append(m.Globs, &BitmapIndex_Entry{})
			if err := m.Globs[len(m.Globs)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *BitmapIndex_AllowActions) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BitmapIndex_AllowActions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BitmapIndex_AllowActions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *BitmapIndex_Binding) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BitmapIndex_Binding: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BitmapIndex_Binding: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoreIndex", wireType)
			}
			m.CoreIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CoreIndex |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 7:
			...
			m.ActionSet = &BitmapIndex_Binding_Action{Action: string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Principal", wireType)
		...
		case 13:
			...
			if oneof, ok := m.ActionSet.(*BitmapIndex_Binding_AllowActions); ok {
				if err := oneof.AllowActions.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &BitmapIndex_AllowActions{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
...
func (m *BitmapIndex_FunctionalCore) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BitmapIndex_FunctionalCore: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BitmapIndex_FunctionalCore: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *BitmapIndex_Parents) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BitmapIndex_Parents: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BitmapIndex_Parents: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *BitmapIndex_RoleParents) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BitmapIndex_RoleParents: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BitmapIndex_RoleParents: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Roles == nil {
				m.Roles = make(map[string]*BitmapIndex_Parents)
			}
			var mapkey string
			var mapvalue *BitmapIndex_Parents
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *BitmapIndex) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BitmapIndex: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BitmapIndex: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Version = append(m.Version, &BitmapIndex_Entry{})
			if err := m.Version[len(m.Version)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			m.Scope = append(m.Scope, &BitmapIndex_Entry{})
		...
		case 3:
			...
			if m.Role == nil {
				m.Role = &BitmapIndex_GlobDimension{}
			}
		...
		case 4:
			...
			if m.Action == nil {
				m.Action = &BitmapIndex_GlobDimension{}
			}
		...
		case 5:
			...
			if m.Resource == nil {
				m.Resource = &BitmapIndex_GlobDimension{}
			}
		...
		case 6:
			...
			if m.PolicyKind == nil {
				m.PolicyKind = make(map[int32][]byte)
			}
			var mapkey int32
			var mapvalue []byte
			for iNdEx < postIndex {
		...
		case 7:
			...
			m.Principal = append(m.Principal, &BitmapIndex_Entry{})
			if err := m.Principal[len(m.Principal)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
			...
			m.Universe = append(m.Universe[:0], dAtA[iNdEx:postIndex]...)
			if m.Universe == nil {
				m.Universe = []byte{}
			}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowActionsBitmap", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllowActionsBitmap = append(m.AllowActionsBitmap[:0], dAtA[iNdEx:postIndex]...)
			if m.AllowActionsBitmap == nil {
				m.AllowActionsBitmap = []byte{}
			}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
			...
			m.Bindings = append(m.Bindings, &BitmapIndex_Binding{})
		...
		case 11:
			...
			m.Cores = append(m.Cores, &BitmapIndex_FunctionalCore{})
			if err := m.Cores[len(m.Cores)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
			...
			if m.ParentRoles == nil {
				m.ParentRoles = make(map[string]*BitmapIndex_RoleParents)
			}
			var mapkey string
			var mapvalue *BitmapIndex_RoleParents
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &BitmapIndex_RoleParents{}
					if err := mapvalue.UnmarshalVT(dAtA[iNdEx:postmsgIndex]); err != nil {
						return err
					}
					iNdEx = postmsgIndex
