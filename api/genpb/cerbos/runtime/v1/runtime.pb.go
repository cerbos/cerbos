...
type RunnableRolePolicySet struct {
	...
	Resources        map[string]*RunnableRolePolicySet_AllowActions `protobuf:"bytes,4,rep,name=resources,proto3" json:"resources,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
