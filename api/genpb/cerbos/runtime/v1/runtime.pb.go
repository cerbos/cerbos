...
type RunnableRolePolicySet struct {
	...
	Resources        map[string]*RunnableRolePolicySet_AllowActions `protobuf:"bytes,6,rep,name=resources,proto3" json:"resources,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
var file_cerbos_runtime_v1_runtime_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x63, 0x65,
