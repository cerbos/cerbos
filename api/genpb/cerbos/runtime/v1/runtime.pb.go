...
type RuleTable struct {
	state               protoimpl.MessageState                    `protogen:"open.v1"`
	Meta                map[string]*RuleTable_Metadata            `protobuf:"bytes,1,rep,name=meta,proto3" json:"meta,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Rules               []*RuleTable_RuleRow                      `protobuf:"bytes,2,rep,name=Rules,proto3" json:"Rules,omitempty"`
	ParentRoleAncestors map[string]*RuleTable_ParentRoleAncestors `protobuf:"bytes,3,rep,name=parent_role_ancestors,json=parentRoleAncestors,proto3" json:"parent_role_ancestors,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Schemas             map[string]*v1.Schemas                    `protobuf:"bytes,4,rep,name=schemas,proto3" json:"schemas,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
