...
func (m *AuxData_JWT) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Claims == nil {
				m.Claims = make(map[string]*structpb1.Value)
			}
			var mapkey string
			var mapvalue *structpb1.Value
			for iNdEx < postIndex {
...
func (m *AuxData) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Jwts == nil {
				m.Jwts = make(map[string]*AuxData_JWT)
			}
			var mapkey string
			var mapvalue *AuxData_JWT
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
