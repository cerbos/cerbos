	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Node.(*PlanResourcesAst_Node_LogicalOperation); ok {
				...
				m.Node = &PlanResourcesAst_Node_LogicalOperation{v}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			if oneof, ok := m.Node.(*PlanResourcesAst_Node_Expression); ok {
				...
				m.Node = &PlanResourcesAst_Node_Expression{v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Node.(*PlanResourcesFilter_Expression_Operand_Value); ok {
				...
				m.Node = &PlanResourcesFilter_Expression_Operand_Value{v}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			if oneof, ok := m.Node.(*PlanResourcesFilter_Expression_Operand_Expression); ok {
				...
				m.Node = &PlanResourcesFilter_Expression_Operand_Expression{v}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Node = &PlanResourcesFilter_Expression_Operand_Variable{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *Trace_Component) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Details = &Trace_Component_Action{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Details = &Trace_Component_DerivedRole{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Expr", wireType)
			...
			m.Details = &Trace_Component_Expr{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
			...
			m.Details = &Trace_Component_Index{v}
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Policy", wireType)
			}
			...
			m.Details = &Trace_Component_Policy{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Resource", wireType)
			...
			m.Details = &Trace_Component_Resource{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
			...
			m.Details = &Trace_Component_Rule{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Scope", wireType)
			...
			m.Details = &Trace_Component_Scope{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Variable", wireType)
			...
			if oneof, ok := m.Details.(*Trace_Component_Variable_); ok {
				...
				m.Details = &Trace_Component_Variable_{v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
