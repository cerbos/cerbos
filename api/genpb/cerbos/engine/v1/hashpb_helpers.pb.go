...
func cerbos_engine_v1_TraceBatch_hashpb_sum(m *TraceBatch, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_engine_v1_TraceEntry_hashpb_sum(m *TraceEntry, hasher hash.Hash, ignore map[string]struct{}) {
