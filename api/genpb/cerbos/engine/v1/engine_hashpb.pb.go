...
// HashPB computes a hash of the message using the given hash function
// The ignore set must contain fully-qualified field names (pkg.msg.field) that should be ignored from the hash
func (m *CrossScopePlanResourcesInput) HashPB(hasher hash.Hash, ignore map[string]struct{}) {
	if m != nil {
		cerbos_engine_v1_CrossScopePlanResourcesInput_hashpb_sum(m, hasher, ignore)
	}
}

// HashPB computes a hash of the message using the given hash function
// The ignore set must contain fully-qualified field names (pkg.msg.field) that should be ignored from the hash
func (m *CrossScopePlanResourcesInput_Resource) HashPB(hasher hash.Hash, ignore map[string]struct{}) {
	if m != nil {
		cerbos_engine_v1_CrossScopePlanResourcesInput_Resource_hashpb_sum(m, hasher, ignore)
	}
}
