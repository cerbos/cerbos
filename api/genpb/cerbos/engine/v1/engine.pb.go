...
const file_cerbos_engine_v1_engine_proto_rawDesc = "" +
	...
	"\finclude_meta\x18\x06 \x01(\bR\vincludeMeta\x1a\xbb\x06\n" +
	"\bResource\x12D\n" +
	...
	"\x04attr\x18\x02 \x03(\v27.cerbos.engine.v1.PlanResourcesInput.Resource.AttrEntryBc\x92A`2^Key-value pairs of contextual data about the resource that are known at a time of the request.R\x04attr\x12\xdc\x01\n" +
	"\x0epolicy_version\x18\x03 \x01(\tB\xb4\x01\x92A\x99\x012|The policy version to use to evaluate this request. If not specified, will default to the server-configured default version.J\t\"default\"\x8a\x01\r^[[:word:]]*$\xe0A\x01\xbaH\x11r\x0f2\r^[[:word:]]*$R\rpolicyVersion\x12\x85\x02\n" +
	"\x05scope\x18\x04 \x01(\tB\xee\x01\x92A\xb1\x012}A dot-separated scope that describes the hierarchy this resource belongs to. This is used for determining policy inheritance.\x8a\x01/^([[:alnum:]][[:word:]\\-]*(\\.[[:word:]\\-]*)*)*$\xe0A\x01\xbaH3r12/^([[:alnum:]][[:word:]\\-]*(\\.[[:word:]\\-]*)*)*$R\x05scope\x1aO\n" +
	"\tAttrEntry\x12\x10\n" +
	...
	"\x03val\x18\x02 \x01(\v2\x16.google.protobuf.ValueBK\x92AH27Dynamic output, determined by user defined rule output.J\r\"some_string\"R\x03val\"\xc8\a\n" +
	"\bResource\x12^\n" +
	"\x04kind\x18\x01 \x01(\tBJ\x92A:2)Name of the resource kind being accessed.J\r\"album:photo\"\xe0A\x02\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04kind\x12\xdc\x01\n" +
	"\x0epolicy_version\x18\x02 \x01(\tB\xb4\x01\x92A\x99\x012|The policy version to use to evaluate this request. If not specified, will default to the server-configured default version.J\t\"default\"\x8a\x01\r^[[:word:]]*$\xe0A\x01\xbaH\x11r\x0f2\r^[[:word:]]*$R\rpolicyVersion\x12F\n" +
	...
	"\x04attr\x18\x04 \x03(\v2$.cerbos.engine.v1.Resource.AttrEntryB\x93\x01\x92A\x7f2dKay-value pairs of contextual data about this resource that should be used during policy evaluation.J\x17{\"owner\": \"bugs_bunny\"}\xbaH\x0e\x9a\x01\v\"\x04r\x02\x10\x01*\x03\xc8\x01\x01R\x04attr\x12\x92\x02\n" +
	"\x05scope\x18\x05 \x01(\tB\xfb\x01\x92A\xbe\x012}A dot-separated scope that describes the hierarchy this resource belongs to. This is used for determining policy inheritance.J\v\"acme.corp\"\x8a\x01/^([[:alnum:]][[:word:]\\-]*(\\.[[:word:]\\-]*)*)*$\xe0A\x01\xbaH3r12/^([[:alnum:]][[:word:]\\-]*(\\.[[:word:]\\-]*)*)*$R\x05scope\x1aO\n" +
	"\tAttrEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01\"\xcc\b\n" +
	"\tPrincipal\x12C\n" +
	"\x02id\x18\x01 \x01(\tB3\x92A#2\x13ID of the principalJ\f\"bugs_bunny\"\xe0A\x02\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x02id\x12\xdc\x01\n" +
	"\x0epolicy_version\x18\x02 \x01(\tB\xb4\x01\x92A\x99\x012|The policy version to use to evaluate this request. If not specified, will default to the server-configured default version.J\t\"default\"\x8a\x01\r^[[:word:]]*$\xe0A\x01\xbaH\x11r\x0f2\r^[[:word:]]*$R\rpolicyVersion\x12\x87\x01\n" +
	...
	"\x04attr\x18\x04 \x03(\v2%.cerbos.engine.v1.Principal.AttrEntryB\x92\x01\x92A~2eKey-value pairs of contextual data about this principal that should be used during policy evaluation.J\x15{\"beta_tester\": true}\xbaH\x0e\x9a\x01\v\"\x04r\x02\x10\x01*\x03\xc8\x01\x01R\x04attr\x12\x93\x02\n" +
	"\x05scope\x18\x05 \x01(\tB\xfc\x01\x92A\xbf\x012~A dot-separated scope that describes the hierarchy this principal belongs to. This is used for determining policy inheritance.J\v\"acme.corp\"\x8a\x01/^([[:alnum:]][[:word:]\\-]*(\\.[[:word:]\\-]*)*)*$\xe0A\x01\xbaH3r12/^([[:alnum:]][[:word:]\\-]*(\\.[[:word:]\\-]*)*)*$R\x05scope\x1aO\n" +
	"\tAttrEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
