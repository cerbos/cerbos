...
func file_cerbos_engine_v1_engine_proto_rawDescGZIP() []byte {
	file_cerbos_engine_v1_engine_proto_rawDescOnce.Do(func() {
		file_cerbos_engine_v1_engine_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_cerbos_engine_v1_engine_proto_rawDescData)))
	})
	return []byte(file_cerbos_engine_v1_engine_proto_rawDescData)
}
