...
func (m *ServerLaunch_Cerbos) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ModuleChecksum) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ModuleChecksum)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ModuleVersion) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ModuleVersion)))
		i--
		dAtA[i] = 0x22
	}
...
func (m *ServerLaunch_Source) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.NumCpus != 0 {
		i = encodeVarint(dAtA, i, uint64(m.NumCpus))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Arch) > 0 {
...
func (m *ServerLaunch_Features_Audit) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Backend) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.Backend)))
		i--
		dAtA[i] = 0x12
	}
	if m.Enabled {
...
func (m *ServerLaunch_Features_Schema) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Enforcement) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.Enforcement)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ServerLaunch_Features_Storage_Git) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PollInterval != nil {
		if vtmsg, ok := interface{}(m.PollInterval).(interface {
			...
			encoded, err := proto.Marshal(m.PollInterval)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *ServerLaunch_Features_Storage_Bundle) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.PdpId) > 0 {
		i -= len(m.PdpId)
		copy(dAtA[i:], m.PdpId)
		i = encodeVarint(dAtA, i, uint64(len(m.PdpId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ServerLaunch_Features_Storage_Git) SizeVT() (n int) {
	...
	if m.PollInterval != nil {
		if size, ok := interface{}(m.PollInterval).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.PollInterval)
		}
		n += 1 + l + sov(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *ServerLaunch_Features_Storage_Git) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PollInterval == nil {
				m.PollInterval = &durationpb.Duration{}
			}
			if unmarshal, ok := interface{}(m.PollInterval).(interface {
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.PollInterval); err != nil {
					return err
				}
			}
			iNdEx = postIndex
