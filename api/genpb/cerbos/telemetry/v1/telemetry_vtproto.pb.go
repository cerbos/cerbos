...
func (m *Ping_Source) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.IpAddressHash != 0 {
		i = encodeVarint(dAtA, i, uint64(m.IpAddressHash))
		i--
		dAtA[i] = 0x28
	}
	if m.NumCpus != 0 {
...
func (m *Ping_Source) SizeVT() (n int) {
	...
	if m.IpAddressHash != 0 {
		n += 1 + sov(uint64(m.IpAddressHash))
	}
	if m.unknownFields != nil {
		n += len(m.unknownFields)
	}
...
func (m *Ping_Source) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IpAddressHash", wireType)
			}
			m.IpAddressHash = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IpAddressHash |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Ping_Features_Storage) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Disk == nil {
				m.Disk = &Ping_Features_Storage_Disk{}
			}
			if err := m.Disk.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			if m.Git == nil {
				m.Git = &Ping_Features_Storage_Git{}
			}
		...
		case 4:
			...
			if m.Blob == nil {
				m.Blob = &Ping_Features_Storage_Blob{}
			}
