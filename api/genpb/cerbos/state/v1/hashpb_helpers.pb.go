...
func cerbos_state_v1_TelemetryState_hashpb_sum(m *TelemetryState, hasher hash.Hash, ignore map[string]struct{}) {
	if _, ok := ignore["cerbos.state.v1.TelemetryState.suspend"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(nil, protowire.EncodeBool(m.Suspend)))

	}
	if _, ok := ignore["cerbos.state.v1.TelemetryState.last_timestamp"]; !ok {
		if m.LastTimestamp != nil {
			google_protobuf_Timestamp_hashpb_sum(m.LastTimestamp, hasher, ignore)
		}

	}
	if _, ok := ignore["cerbos.state.v1.TelemetryState.last_payload"]; !ok {
		if m.LastPayload != nil {
			cerbos_telemetry_v1_Ping_hashpb_sum(m.LastPayload, hasher, ignore)
		}

	}
}

func cerbos_telemetry_v1_Ping_Cerbos_hashpb_sum(m *v1.Ping_Cerbos, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_telemetry_v1_Ping_Features_AdminApi_hashpb_sum(m *v1.Ping_Features_AdminApi, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_telemetry_v1_Ping_Features_Audit_hashpb_sum(m *v1.Ping_Features_Audit, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_telemetry_v1_Ping_Features_Schema_hashpb_sum(m *v1.Ping_Features_Schema, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_telemetry_v1_Ping_Features_Storage_Blob_hashpb_sum(m *v1.Ping_Features_Storage_Blob, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_telemetry_v1_Ping_Features_Storage_Disk_hashpb_sum(m *v1.Ping_Features_Storage_Disk, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_telemetry_v1_Ping_Features_Storage_Git_hashpb_sum(m *v1.Ping_Features_Storage_Git, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_telemetry_v1_Ping_Features_Storage_hashpb_sum(m *v1.Ping_Features_Storage, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_telemetry_v1_Ping_Features_hashpb_sum(m *v1.Ping_Features, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_telemetry_v1_Ping_Source_hashpb_sum(m *v1.Ping_Source, hasher hash.Hash, ignore map[string]struct{}) {
...
func cerbos_telemetry_v1_Ping_hashpb_sum(m *v1.Ping, hasher hash.Hash, ignore map[string]struct{}) {
