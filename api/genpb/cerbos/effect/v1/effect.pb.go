...
func file_cerbos_effect_v1_effect_proto_rawDescGZIP() []byte {
	file_cerbos_effect_v1_effect_proto_rawDescOnce.Do(func() {
		file_cerbos_effect_v1_effect_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_cerbos_effect_v1_effect_proto_rawDescData)))
	})
	return []byte(file_cerbos_effect_v1_effect_proto_rawDescData)
}
