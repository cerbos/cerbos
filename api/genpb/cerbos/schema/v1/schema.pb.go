...
var file_cerbos_schema_v1_schema_proto_rawDesc = string([]byte{
...
func file_cerbos_schema_v1_schema_proto_rawDescGZIP() []byte {
	file_cerbos_schema_v1_schema_proto_rawDescOnce.Do(func() {
		file_cerbos_schema_v1_schema_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_cerbos_schema_v1_schema_proto_rawDescData)))
	})
	return []byte(file_cerbos_schema_v1_schema_proto_rawDescData)
}
