...
func (x *SchemaWithoutDef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SchemaWithoutDef) ProtoMessage() {}

func (x *SchemaWithoutDef) ProtoReflect() protoreflect.Message {
	mi := &file_cerbos_schema_v1_schema_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SchemaWithoutDef.ProtoReflect.Descriptor instead.
func (*SchemaWithoutDef) Descriptor() ([]byte, []int) {
	return file_cerbos_schema_v1_schema_proto_rawDescGZIP(), []int{2}
}

func (x *SchemaWithoutDef) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_cerbos_schema_v1_schema_proto_rawDesc = []byte{
	...
	0x31, 0x22, 0xce, 0x01, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x10, 0x02, 0x22, 0x38, 0x0a, 0x06, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x52, 0x0a, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x22, 0x0a, 0x10,
	0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x57, 0x69, 0x74, 0x68, 0x6f, 0x75, 0x74, 0x44, 0x65, 0x66,
...
var file_cerbos_schema_v1_schema_proto_goTypes = []interface{}{
	...
	(*SchemaWithoutDef)(nil),    // 3: cerbos.schema.v1.SchemaWithoutDef
}
