...
// Validate checks the field values on SchemaWithoutDef with the rules defined
// in the proto definition for this message. If any rules are violated, an
// error is returned.
func (m *SchemaWithoutDef) Validate() error {
	if m == nil {
		return nil
	}
...
// SchemaWithoutDefValidationError is the validation error returned by
// SchemaWithoutDef.Validate if the designated constraints aren't met.
type SchemaWithoutDefValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SchemaWithoutDefValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SchemaWithoutDefValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SchemaWithoutDefValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SchemaWithoutDefValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SchemaWithoutDefValidationError) ErrorName() string { return "SchemaWithoutDefValidationError" }

// Error satisfies the builtin error interface
func (e SchemaWithoutDefValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSchemaWithoutDef.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SchemaWithoutDefValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SchemaWithoutDefValidationError{}
