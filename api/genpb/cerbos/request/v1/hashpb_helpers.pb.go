...
func cerbos_request_v1_InspectPoliciesRequest_hashpb_sum(m *InspectPoliciesRequest, hasher hash.Hash, ignore map[string]struct{}) {
	...
	if _, ok := ignore["cerbos.request.v1.InspectPoliciesRequest.name_regexp"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(nil, uint64(len(m.GetNameRegexp()))))
	...
	if _, ok := ignore["cerbos.request.v1.InspectPoliciesRequest.scope_regexp"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(nil, uint64(len(m.GetScopeRegexp()))))
	...
	if _, ok := ignore["cerbos.request.v1.InspectPoliciesRequest.version_regexp"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(nil, uint64(len(m.GetVersionRegexp()))))
	...
	if m.Filter != nil {
		if _, ok := ignore["cerbos.request.v1.ListAuditLogEntriesRequest.filter"]; !ok {
			...
			case *ListAuditLogEntriesRequest_Lookup:
				_, _ = hasher.Write(protowire.AppendVarint(nil, uint64(len(t.Lookup))))
