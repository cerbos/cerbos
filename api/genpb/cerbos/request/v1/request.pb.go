...
type PlaygroundTestRequest struct {
	...
	PlaygroundId string        `protobuf:"bytes,1,opt,name=playground_id,json=playgroundId,proto3" json:"playground_id,omitempty"`
	Files        []*PolicyFile `protobuf:"bytes,2,rep,name=files,proto3" json:"files,omitempty"`
}
...
func (x *PlaygroundTestRequest) GetFiles() []*PolicyFile {
	if x != nil {
		return x.Files
	}
	return nil
...
var file_cerbos_request_v1_request_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x20, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xca, 0x01, 0x0a, 0x15, 0x50,
	...
	0x79, 0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x49, 0x64, 0x12, 0x6c, 0x0a, 0x05, 0x66, 0x69, 0x6c,
	...
	0x69, 0x63, 0x79, 0x46, 0x69, 0x6c, 0x65, 0x42, 0x37, 0x92, 0x41, 0x26, 0x32, 0x1e, 0x4c, 0x69,
	0x73, 0x74, 0x20, 0x6f, 0x66, 0x20, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x20, 0x61, 0x6e, 0x64,
	0x20, 0x74, 0x65, 0x73, 0x74, 0x20, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2e, 0xa0, 0x01, 0x1e, 0xa8,
...
var file_cerbos_request_v1_request_proto_depIdxs = []int32{
	...
	7,  // 13: cerbos.request.v1.PlaygroundTestRequest.files:type_name -> cerbos.request.v1.PolicyFile
