...
var file_cerbos_request_v1_request_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0x73, 0x0a, 0x19, 0x64, 0x65, 0x76, 0x2e,
...
var file_cerbos_request_v1_request_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_cerbos_request_v1_request_proto_goTypes = []interface{}{
	...
	nil,                                          // 10: cerbos.request.v1.ResourceSet.InstancesEntry
	nil,                                          // 11: cerbos.request.v1.AttributesMap.AttrEntry
	(*CheckResourceBatchRequest_BatchEntry)(nil), // 12: cerbos.request.v1.CheckResourceBatchRequest.BatchEntry
	(*ListAuditLogEntriesRequest_TimeRange)(nil), // 13: cerbos.request.v1.ListAuditLogEntriesRequest.TimeRange
	(*v1.Principal)(nil),                         // 14: cerbos.engine.v1.Principal
	(*v1.Resource)(nil),                          // 15: cerbos.engine.v1.Resource
...
var file_cerbos_request_v1_request_proto_depIdxs = []int32{
	14, // 0: cerbos.request.v1.CheckResourceSetRequest.principal:type_name -> cerbos.engine.v1.Principal
	2,  // 1: cerbos.request.v1.CheckResourceSetRequest.resource:type_name -> cerbos.request.v1.ResourceSet
	10, // 2: cerbos.request.v1.ResourceSet.instances:type_name -> cerbos.request.v1.ResourceSet.InstancesEntry
	11, // 3: cerbos.request.v1.AttributesMap.attr:type_name -> cerbos.request.v1.AttributesMap.AttrEntry
	14, // 4: cerbos.request.v1.CheckResourceBatchRequest.principal:type_name -> cerbos.engine.v1.Principal
	12, // 5: cerbos.request.v1.CheckResourceBatchRequest.resources:type_name -> cerbos.request.v1.CheckResourceBatchRequest.BatchEntry
	...
	14, // 8: cerbos.request.v1.PlaygroundEvaluateRequest.principal:type_name -> cerbos.engine.v1.Principal
	15, // 9: cerbos.request.v1.PlaygroundEvaluateRequest.resource:type_name -> cerbos.engine.v1.Resource
	16, // 10: cerbos.request.v1.AddOrUpdatePolicyRequest.policies:type_name -> cerbos.policy.v1.Policy
	0,  // 11: cerbos.request.v1.ListAuditLogEntriesRequest.kind:type_name -> cerbos.request.v1.ListAuditLogEntriesRequest.Kind
	13, // 12: cerbos.request.v1.ListAuditLogEntriesRequest.between:type_name -> cerbos.request.v1.ListAuditLogEntriesRequest.TimeRange
	17, // 13: cerbos.request.v1.ListAuditLogEntriesRequest.since:type_name -> google.protobuf.Duration
	3,  // 14: cerbos.request.v1.ResourceSet.InstancesEntry.value:type_name -> cerbos.request.v1.AttributesMap
	18, // 15: cerbos.request.v1.AttributesMap.AttrEntry.value:type_name -> google.protobuf.Value
	15, // 16: cerbos.request.v1.CheckResourceBatchRequest.BatchEntry.resource:type_name -> cerbos.engine.v1.Resource
	19, // 17: cerbos.request.v1.ListAuditLogEntriesRequest.TimeRange.start:type_name -> google.protobuf.Timestamp
	19, // 18: cerbos.request.v1.ListAuditLogEntriesRequest.TimeRange.end:type_name -> google.protobuf.Timestamp
