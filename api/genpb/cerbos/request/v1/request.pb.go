...
type PlaygroundTestRequest struct {
	...
	PlaygroundId string        `protobuf:"bytes,1,opt,name=playground_id,json=playgroundId,proto3" json:"playground_id,omitempty"`
	PolicyFiles  []*PolicyFile `protobuf:"bytes,2,rep,name=policy_files,json=policyFiles,proto3" json:"policy_files,omitempty"`
	TestFiles    []*PolicyFile `protobuf:"bytes,3,rep,name=test_files,json=testFiles,proto3" json:"test_files,omitempty"`
}
...
func (x *PlaygroundTestRequest) GetTestFiles() []*PolicyFile {
	if x != nil {
		return x.TestFiles
	}
	return nil
...
var file_cerbos_request_v1_request_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x20, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xba, 0x02, 0x0a, 0x15, 0x50,
	...
	,
	...
	0x6c, 0x69, 0x63, 0x79, 0x20, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2e, 0xa0, 0x01, 0x1e, 0xa8, 0x01,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x86, 0x04, 0x0a, 0x16, 0x50, 0x6c, 0x61, 0x79, 0x67,
	...
	0x69, 0x63, 0x79, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x5a, 0x0a, 0x12, 0x63, 0x68, 0x65, 0x63,
	...
	0x65, 0x42, 0x61, 0x74, 0x63, 0x68, 0x12, 0x60, 0x0a, 0x14, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	0x73, 0x74, 0x48, 0x00, 0x52, 0x12, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x50, 0x6c, 0x61, 0x6e, 0x3a, 0x1f, 0x92, 0x41, 0x1c, 0x0a, 0x1a, 0x32,
...
var file_cerbos_request_v1_request_proto_depIdxs = []int32{
	...
	7,  // 14: cerbos.request.v1.PlaygroundTestRequest.test_files:type_name -> cerbos.request.v1.PolicyFile
	7,  // 15: cerbos.request.v1.PlaygroundEvaluateRequest.policy_files:type_name -> cerbos.request.v1.PolicyFile
	26, // 16: cerbos.request.v1.PlaygroundEvaluateRequest.principal:type_name -> cerbos.engine.v1.Principal
	28, // 17: cerbos.request.v1.PlaygroundEvaluateRequest.resource:type_name -> cerbos.engine.v1.Resource
	6,  // 18: cerbos.request.v1.PlaygroundEvaluateRequest.aux_data:type_name -> cerbos.request.v1.AuxData
	7,  // 19: cerbos.request.v1.PlaygroundProxyRequest.policy_files:type_name -> cerbos.request.v1.PolicyFile
	2,  // 20: cerbos.request.v1.PlaygroundProxyRequest.check_resource_set:type_name -> cerbos.request.v1.CheckResourceSetRequest
	5,  // 21: cerbos.request.v1.PlaygroundProxyRequest.check_resource_batch:type_name -> cerbos.request.v1.CheckResourceBatchRequest
	1,  // 22: cerbos.request.v1.PlaygroundProxyRequest.resources_query_plan:type_name -> cerbos.request.v1.ResourcesQueryPlanRequest
	29, // 23: cerbos.request.v1.AddOrUpdatePolicyRequest.policies:type_name -> cerbos.policy.v1.Policy
	0,  // 24: cerbos.request.v1.ListAuditLogEntriesRequest.kind:type_name -> cerbos.request.v1.ListAuditLogEntriesRequest.Kind
	25, // 25: cerbos.request.v1.ListAuditLogEntriesRequest.between:type_name -> cerbos.request.v1.ListAuditLogEntriesRequest.TimeRange
	30, // 26: cerbos.request.v1.ListAuditLogEntriesRequest.since:type_name -> google.protobuf.Duration
	31, // 27: cerbos.request.v1.AddOrUpdateSchemaRequest.schemas:type_name -> cerbos.schema.v1.Schema
	4,  // 28: cerbos.request.v1.ResourceSet.InstancesEntry.value:type_name -> cerbos.request.v1.AttributesMap
	32, // 29: cerbos.request.v1.AttributesMap.AttrEntry.value:type_name -> google.protobuf.Value
	28, // 30: cerbos.request.v1.CheckResourceBatchRequest.BatchEntry.resource:type_name -> cerbos.engine.v1.Resource
	33, // 31: cerbos.request.v1.ListAuditLogEntriesRequest.TimeRange.start:type_name -> google.protobuf.Timestamp
	33, // 32: cerbos.request.v1.ListAuditLogEntriesRequest.TimeRange.end:type_name -> google.protobuf.Timestamp
