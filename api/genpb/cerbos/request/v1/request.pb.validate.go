...
// Validate checks the field values on FilterPoliciesRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *FilterPoliciesRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on FilterPoliciesRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// FilterPoliciesRequestMultiError, or nil if none found.
func (m *FilterPoliciesRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *FilterPoliciesRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// FilterPoliciesRequestMultiError is an error wrapping multiple validation
// errors returned by FilterPoliciesRequest.ValidateAll() if the designated
// constraints aren't met.
type FilterPoliciesRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m FilterPoliciesRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m FilterPoliciesRequestMultiError) AllErrors() []error { return m }

// FilterPoliciesRequestValidationError is the validation error returned by
// FilterPoliciesRequest.Validate if the designated constraints aren't met.
type FilterPoliciesRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e FilterPoliciesRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e FilterPoliciesRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e FilterPoliciesRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e FilterPoliciesRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e FilterPoliciesRequestValidationError) ErrorName() string {
	return "FilterPoliciesRequestValidationError"
}

// Error satisfies the builtin error interface
func (e FilterPoliciesRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sFilterPoliciesRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = FilterPoliciesRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = FilterPoliciesRequestValidationError{}
