...
func (m *ListSchemasRequest_Filter) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ListSchemasRequest_Filter) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ListSchemasRequest_Filter) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *ListSchemasRequest_SortOptions) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ListSchemasRequest_SortOptions) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ListSchemasRequest_SortOptions) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *ListSchemasRequest_Filter) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ListSchemasRequest_SortOptions) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ListSchemasRequest_Filter) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ListSchemasRequest_Filter: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ListSchemasRequest_Filter: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= ListSchemasRequest_MatchType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ListSchemasRequest_SortOptions) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ListSchemasRequest_SortOptions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ListSchemasRequest_SortOptions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Column |= ListSchemasRequest_SortOptions_Column(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Order |= ListSchemasRequest_SortOptions_Order(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ListSchemasRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Filters = append(m.Filters, &ListSchemasRequest_Filter{})
			if err := m.Filters[len(m.Filters)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			if m.SortOptions == nil {
				m.SortOptions = &ListSchemasRequest_SortOptions{}
			}
			if err := m.SortOptions.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
