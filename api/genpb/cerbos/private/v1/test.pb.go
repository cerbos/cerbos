...
func file_cerbos_private_v1_test_proto_rawDescGZIP() []byte {
	file_cerbos_private_v1_test_proto_rawDescOnce.Do(func() {
		file_cerbos_private_v1_test_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_cerbos_private_v1_test_proto_rawDescData)))
	})
	return []byte(file_cerbos_private_v1_test_proto_rawDescData)
}
