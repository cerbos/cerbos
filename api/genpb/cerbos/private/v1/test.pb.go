...
type CrossScopeQueryPlannerTestSuite struct {
	state         protoimpl.MessageState                  `protogen:"open.v1"`
	Description   string                                  `protobuf:"bytes,1,opt,name=description,proto3" json:"description,omitempty"`
	Principal     *v11.Principal                          `protobuf:"bytes,2,opt,name=principal,proto3" json:"principal,omitempty"`
	Tests         []*CrossScopeQueryPlannerTestSuite_Test `protobuf:"bytes,3,rep,name=tests,proto3" json:"tests,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CrossScopeQueryPlannerTestSuite) Reset() {
	*x = CrossScopeQueryPlannerTestSuite{}
	mi := &file_cerbos_private_v1_test_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CrossScopeQueryPlannerTestSuite) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CrossScopeQueryPlannerTestSuite) ProtoMessage() {}

func (x *CrossScopeQueryPlannerTestSuite) ProtoReflect() protoreflect.Message {
	mi := &file_cerbos_private_v1_test_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CrossScopeQueryPlannerTestSuite.ProtoReflect.Descriptor instead.
func (*CrossScopeQueryPlannerTestSuite) Descriptor() ([]byte, []int) {
	return file_cerbos_private_v1_test_proto_rawDescGZIP(), []int{11}
}

func (x *CrossScopeQueryPlannerTestSuite) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *CrossScopeQueryPlannerTestSuite) GetPrincipal() *v11.Principal {
	if x != nil {
		return x.Principal
	}
	return nil
...
func (x *CrossScopeQueryPlannerTestSuite) GetTests() []*CrossScopeQueryPlannerTestSuite_Test {
	if x != nil {
		return x.Tests
	}
	return nil
...
type CrossScopeQueryPlannerTestSuite_Test struct {
	state         protoimpl.MessageState                     `protogen:"open.v1"`
	Action        string                                     `protobuf:"bytes,1,opt,name=action,proto3" json:"action,omitempty"`
	Want          *v11.PlanResourcesFilter                   `protobuf:"bytes,2,opt,name=want,proto3" json:"want,omitempty"`
	Resource      *v11.CrossScopePlanResourcesInput_Resource `protobuf:"bytes,3,opt,name=resource,proto3" json:"resource,omitempty"`
	WantErr       bool                                       `protobuf:"varint,4,opt,name=want_err,json=wantErr,proto3" json:"want_err,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CrossScopeQueryPlannerTestSuite_Test) Reset() {
	*x = CrossScopeQueryPlannerTestSuite_Test{}
	mi := &file_cerbos_private_v1_test_proto_msgTypes[48]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CrossScopeQueryPlannerTestSuite_Test) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CrossScopeQueryPlannerTestSuite_Test) ProtoMessage() {}

func (x *CrossScopeQueryPlannerTestSuite_Test) ProtoReflect() protoreflect.Message {
	mi := &file_cerbos_private_v1_test_proto_msgTypes[48]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CrossScopeQueryPlannerTestSuite_Test.ProtoReflect.Descriptor instead.
func (*CrossScopeQueryPlannerTestSuite_Test) Descriptor() ([]byte, []int) {
	return file_cerbos_private_v1_test_proto_rawDescGZIP(), []int{11, 0}
}

func (x *CrossScopeQueryPlannerTestSuite_Test) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
func (x *CrossScopeQueryPlannerTestSuite_Test) GetWant() *v11.PlanResourcesFilter {
	if x != nil {
		return x.Want
	}
	return nil
...
func (x *CrossScopeQueryPlannerTestSuite_Test) GetResource() *v11.CrossScopePlanResourcesInput_Resource {
	if x != nil {
		return x.Resource
	}
	return nil
...
func (x *CrossScopeQueryPlannerTestSuite_Test) GetWantErr() bool {
	if x != nil {
		return x.WantErr
	}
	return false
...
func (*WellKnownTypes_Nested) Descriptor() ([]byte, []int) {
	return file_cerbos_private_v1_test_proto_rawDescGZIP(), []int{16, 0}
}
...
var file_cerbos_private_v1_test_proto_rawDesc = string([]byte{
	...
	,
	...
	0x73, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x04, 0x77, 0x61, 0x6e, 0x74, 0x12, 0x53, 0x0a,
	0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x37, 0x2e, 0x63, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x43, 0x72, 0x6f, 0x73, 0x73, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x50, 0x6c, 0x61,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x77, 0x61, 0x6e, 0x74, 0x45, 0x72, 0x72, 0x22, 0xa9, 0x01,
	0x0a, 0x22, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x54, 0x65, 0x73, 0x74, 0x53, 0x75, 0x69, 0x74,
	0x65, 0x52, 0x75, 0x6e, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74, 0x73, 0x54, 0x65, 0x73, 0x74,
	...
	0x22, 0xdf, 0x02, 0x0a, 0x0e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x54, 0x65, 0x73, 0x74, 0x43,
	...
	,
...
var file_cerbos_private_v1_test_proto_goTypes = []any{
	...
	(*CrossScopeQueryPlannerTestSuite)(nil),       // 11: cerbos.private.v1.CrossScopeQueryPlannerTestSuite
	(*VerifyTestSuiteRunGetTestsTestCase)(nil),    // 12: cerbos.private.v1.VerifyTestSuiteRunGetTestsTestCase
	(*QueryPlannerFilterTestCase)(nil),            // 13: cerbos.private.v1.QueryPlannerFilterTestCase
	(*VerifyTestCase)(nil),                        // 14: cerbos.private.v1.VerifyTestCase
	(*ProtoYamlTestCase)(nil),                     // 15: cerbos.private.v1.ProtoYamlTestCase
	(*WellKnownTypes)(nil),                        // 16: cerbos.private.v1.WellKnownTypes
	...
	nil, // 19: cerbos.private.v1.InspectTestCase.PoliciesExpectation.PoliciesEntry
	(*InspectTestCase_PolicySetsExpectation_CompileErrors)(nil), // 20: cerbos.private.v1.InspectTestCase.PolicySetsExpectation.CompileErrors
	nil,                             // 21: cerbos.private.v1.InspectTestCase.PolicySetsExpectation.PolicySetsEntry
	(*BlobClonerTestCase_File)(nil), // 22: cerbos.private.v1.BlobClonerTestCase.File
	(*BlobClonerTestCase_Step)(nil), // 23: cerbos.private.v1.BlobClonerTestCase.Step
	(*BlobClonerTestCase_File_AddOrUpdate)(nil),       // 24: cerbos.private.v1.BlobClonerTestCase.File.AddOrUpdate
	(*BlobClonerTestCase_File_Delete)(nil),            // 25: cerbos.private.v1.BlobClonerTestCase.File.Delete
	(*BlobClonerTestCase_Step_Differences)(nil),       // 26: cerbos.private.v1.BlobClonerTestCase.Step.Differences
	(*BlobClonerTestCase_Step_Expectation)(nil),       // 27: cerbos.private.v1.BlobClonerTestCase.Step.Expectation
	(*BlobClonerTestCase_Step_Expectation_Files)(nil), // 28: cerbos.private.v1.BlobClonerTestCase.Step.Expectation.Files
	(*BlobClonerTestCase_Step_Expectation_Info)(nil),  // 29: cerbos.private.v1.BlobClonerTestCase.Step.Expectation.Info
	nil,                                      // 30: cerbos.private.v1.BlobClonerTestCase.Step.Expectation.AllEntry
	(*ServerTestCase_PlanResourcesCall)(nil), // 31: cerbos.private.v1.ServerTestCase.PlanResourcesCall
	(*ServerTestCase_CheckResourceSetCall)(nil),       // 32: cerbos.private.v1.ServerTestCase.CheckResourceSetCall
	(*ServerTestCase_CheckResourceBatchCall)(nil),     // 33: cerbos.private.v1.ServerTestCase.CheckResourceBatchCall
	(*ServerTestCase_CheckResourcesCall)(nil),         // 34: cerbos.private.v1.ServerTestCase.CheckResourcesCall
	(*ServerTestCase_PlaygroundValidateCall)(nil),     // 35: cerbos.private.v1.ServerTestCase.PlaygroundValidateCall
	(*ServerTestCase_PlaygroundTestCall)(nil),         // 36: cerbos.private.v1.ServerTestCase.PlaygroundTestCall
	(*ServerTestCase_PlaygroundEvaluateCall)(nil),     // 37: cerbos.private.v1.ServerTestCase.PlaygroundEvaluateCall
	(*ServerTestCase_PlaygroundProxyCall)(nil),        // 38: cerbos.private.v1.ServerTestCase.PlaygroundProxyCall
	(*ServerTestCase_AdminAddOrUpdatePolicyCall)(nil), // 39: cerbos.private.v1.ServerTestCase.AdminAddOrUpdatePolicyCall
	(*ServerTestCase_AdminAddOrUpdateSchemaCall)(nil), // 40: cerbos.private.v1.ServerTestCase.AdminAddOrUpdateSchemaCall
	(*ServerTestCase_Status)(nil),                     // 41: cerbos.private.v1.ServerTestCase.Status
	(*IndexBuilderTestCase_CompilationUnit)(nil),      // 42: cerbos.private.v1.IndexBuilderTestCase.CompilationUnit
	nil,                               // 43: cerbos.private.v1.IndexBuilderTestCase.FilesEntry
	(*CompileTestCase_Variables)(nil), // 44: cerbos.private.v1.CompileTestCase.Variables
	(*CompileTestCase_Variables_DerivedRole)(nil), // 45: cerbos.private.v1.CompileTestCase.Variables.DerivedRole
	nil,                                // 46: cerbos.private.v1.AttrWrapper.AttrEntry
	(*QueryPlannerTestSuite_Test)(nil), // 47: cerbos.private.v1.QueryPlannerTestSuite.Test
	(*CrossScopeQueryPlannerTestSuite_Test)(nil),      // 48: cerbos.private.v1.CrossScopeQueryPlannerTestSuite.Test
	...
	(*v11.CrossScopePlanResourcesInput_Resource)(nil), // 106: cerbos.engine.v1.CrossScopePlanResourcesInput.Resource
}
var file_cerbos_private_v1_test_proto_depIdxs = []int32{
	...
	22,  // 3: cerbos.private.v1.BlobClonerTestCase.inputs:type_name -> cerbos.private.v1.BlobClonerTestCase.File
	23,  // 4: cerbos.private.v1.BlobClonerTestCase.steps:type_name -> cerbos.private.v1.BlobClonerTestCase.Step
	53,  // 5: cerbos.private.v1.EngineTestCase.inputs:type_name -> cerbos.engine.v1.CheckInput
	54,  // 6: cerbos.private.v1.EngineTestCase.want_outputs:type_name -> cerbos.engine.v1.CheckOutput
	55,  // 7: cerbos.private.v1.EngineTestCase.want_decision_logs:type_name -> cerbos.audit.v1.DecisionLogEntry
	41,  // 8: cerbos.private.v1.ServerTestCase.want_status:type_name -> cerbos.private.v1.ServerTestCase.Status
	32,  // 9: cerbos.private.v1.ServerTestCase.check_resource_set:type_name -> cerbos.private.v1.ServerTestCase.CheckResourceSetCall
	33,  // 10: cerbos.private.v1.ServerTestCase.check_resource_batch:type_name -> cerbos.private.v1.ServerTestCase.CheckResourceBatchCall
	35,  // 11: cerbos.private.v1.ServerTestCase.playground_validate:type_name -> cerbos.private.v1.ServerTestCase.PlaygroundValidateCall
	37,  // 12: cerbos.private.v1.ServerTestCase.playground_evaluate:type_name -> cerbos.private.v1.ServerTestCase.PlaygroundEvaluateCall
	39,  // 13: cerbos.private.v1.ServerTestCase.admin_add_or_update_policy:type_name -> cerbos.private.v1.ServerTestCase.AdminAddOrUpdatePolicyCall
	38,  // 14: cerbos.private.v1.ServerTestCase.playground_proxy:type_name -> cerbos.private.v1.ServerTestCase.PlaygroundProxyCall
	31,  // 15: cerbos.private.v1.ServerTestCase.plan_resources:type_name -> cerbos.private.v1.ServerTestCase.PlanResourcesCall
	40,  // 16: cerbos.private.v1.ServerTestCase.admin_add_or_update_schema:type_name -> cerbos.private.v1.ServerTestCase.AdminAddOrUpdateSchemaCall
	36,  // 17: cerbos.private.v1.ServerTestCase.playground_test:type_name -> cerbos.private.v1.ServerTestCase.PlaygroundTestCall
	34,  // 18: cerbos.private.v1.ServerTestCase.check_resources:type_name -> cerbos.private.v1.ServerTestCase.CheckResourcesCall
	43,  // 19: cerbos.private.v1.IndexBuilderTestCase.files:type_name -> cerbos.private.v1.IndexBuilderTestCase.FilesEntry
	56,  // 20: cerbos.private.v1.IndexBuilderTestCase.want_err_list:type_name -> cerbos.runtime.v1.IndexBuildErrors
	42,  // 21: cerbos.private.v1.IndexBuilderTestCase.want_compilation_units:type_name -> cerbos.private.v1.IndexBuilderTestCase.CompilationUnit
	57,  // 22: cerbos.private.v1.CompileTestCase.want_errors:type_name -> cerbos.runtime.v1.CompileErrors.Err
	44,  // 23: cerbos.private.v1.CompileTestCase.want_variables:type_name -> cerbos.private.v1.CompileTestCase.Variables
	58,  // 24: cerbos.private.v1.CelTestCase.condition:type_name -> cerbos.policy.v1.Match
	59,  // 25: cerbos.private.v1.CelTestCase.request:type_name -> cerbos.engine.v1.Request
	60,  // 26: cerbos.private.v1.SchemaTestCase.schema_refs:type_name -> cerbos.policy.v1.Schemas
	53,  // 27: cerbos.private.v1.SchemaTestCase.check_input:type_name -> cerbos.engine.v1.CheckInput
	61,  // 28: cerbos.private.v1.SchemaTestCase.plan_resources_input:type_name -> cerbos.engine.v1.PlanResourcesInput
	62,  // 29: cerbos.private.v1.SchemaTestCase.want_validation_errors:type_name -> cerbos.schema.v1.ValidationError
	62,  // 30: cerbos.private.v1.ValidationErrContainer.errors:type_name -> cerbos.schema.v1.ValidationError
	46,  // 31: cerbos.private.v1.AttrWrapper.attr:type_name -> cerbos.private.v1.AttrWrapper.AttrEntry
	63,  // 32: cerbos.private.v1.QueryPlannerTestSuite.principal:type_name -> cerbos.engine.v1.Principal
	47,  // 33: cerbos.private.v1.QueryPlannerTestSuite.tests:type_name -> cerbos.private.v1.QueryPlannerTestSuite.Test
	63,  // 34: cerbos.private.v1.CrossScopeQueryPlannerTestSuite.principal:type_name -> cerbos.engine.v1.Principal
	48,  // 35: cerbos.private.v1.CrossScopeQueryPlannerTestSuite.tests:type_name -> cerbos.private.v1.CrossScopeQueryPlannerTestSuite.Test
	64,  // 36: cerbos.private.v1.VerifyTestSuiteRunGetTestsTestCase.table:type_name -> cerbos.policy.v1.TestTable
	65,  // 37: cerbos.private.v1.VerifyTestSuiteRunGetTestsTestCase.want_tests:type_name -> cerbos.policy.v1.Test
	66,  // 38: cerbos.private.v1.QueryPlannerFilterTestCase.input:type_name -> cerbos.engine.v1.PlanResourcesFilter
	66,  // 39: cerbos.private.v1.QueryPlannerFilterTestCase.want_filter:type_name -> cerbos.engine.v1.PlanResourcesFilter
	49,  // 40: cerbos.private.v1.VerifyTestCase.config:type_name -> cerbos.private.v1.VerifyTestCase.Config
	50,  // 41: cerbos.private.v1.ProtoYamlTestCase.want:type_name -> cerbos.private.v1.ProtoYamlTestCase.Want
	67,  // 42: cerbos.private.v1.ProtoYamlTestCase.want_errors:type_name -> cerbos.source.v1.Error
	68,  // 43: cerbos.private.v1.WellKnownTypes.bool_wrapper:type_name -> google.protobuf.BoolValue
	69,  // 44: cerbos.private.v1.WellKnownTypes.int32_wrapper:type_name -> google.protobuf.Int32Value
	70,  // 45: cerbos.private.v1.WellKnownTypes.int64_wrapper:type_name -> google.protobuf.Int64Value
	71,  // 46: cerbos.private.v1.WellKnownTypes.uint32_wrapper:type_name -> google.protobuf.UInt32Value
	72,  // 47: cerbos.private.v1.WellKnownTypes.uint64_wrapper:type_name -> google.protobuf.UInt64Value
	73,  // 48: cerbos.private.v1.WellKnownTypes.float_wrapper:type_name -> google.protobuf.FloatValue
	74,  // 49: cerbos.private.v1.WellKnownTypes.double_wrapper:type_name -> google.protobuf.DoubleValue
	75,  // 50: cerbos.private.v1.WellKnownTypes.string_wrapper:type_name -> google.protobuf.StringValue
	76,  // 51: cerbos.private.v1.WellKnownTypes.bytes_wrapper:type_name -> google.protobuf.BytesValue
	68,  // 52: cerbos.private.v1.WellKnownTypes.repeated_bool_wrapper:type_name -> google.protobuf.BoolValue
	69,  // 53: cerbos.private.v1.WellKnownTypes.repeated_int32_wrapper:type_name -> google.protobuf.Int32Value
	70,  // 54: cerbos.private.v1.WellKnownTypes.repeated_int64_wrapper:type_name -> google.protobuf.Int64Value
	71,  // 55: cerbos.private.v1.WellKnownTypes.repeated_uint32_wrapper:type_name -> google.protobuf.UInt32Value
	72,  // 56: cerbos.private.v1.WellKnownTypes.repeated_uint64_wrapper:type_name -> google.protobuf.UInt64Value
	73,  // 57: cerbos.private.v1.WellKnownTypes.repeated_float_wrapper:type_name -> google.protobuf.FloatValue
	74,  // 58: cerbos.private.v1.WellKnownTypes.repeated_double_wrapper:type_name -> google.protobuf.DoubleValue
	75,  // 59: cerbos.private.v1.WellKnownTypes.repeated_string_wrapper:type_name -> google.protobuf.StringValue
	76,  // 60: cerbos.private.v1.WellKnownTypes.repeated_bytes_wrapper:type_name -> google.protobuf.BytesValue
	77,  // 61: cerbos.private.v1.WellKnownTypes.duration:type_name -> google.protobuf.Duration
	78,  // 62: cerbos.private.v1.WellKnownTypes.timestamp:type_name -> google.protobuf.Timestamp
	79,  // 63: cerbos.private.v1.WellKnownTypes.struct:type_name -> google.protobuf.Struct
	80,  // 64: cerbos.private.v1.WellKnownTypes.any:type_name -> google.protobuf.Any
	81,  // 65: cerbos.private.v1.WellKnownTypes.value:type_name -> google.protobuf.Value
	82,  // 66: cerbos.private.v1.WellKnownTypes.null_value:type_name -> google.protobuf.NullValue
	77,  // 67: cerbos.private.v1.WellKnownTypes.repeated_duration:type_name -> google.protobuf.Duration
	78,  // 68: cerbos.private.v1.WellKnownTypes.repeated_timestamp:type_name -> google.protobuf.Timestamp
	79,  // 69: cerbos.private.v1.WellKnownTypes.repeated_struct:type_name -> google.protobuf.Struct
	80,  // 70: cerbos.private.v1.WellKnownTypes.repeated_any:type_name -> google.protobuf.Any
	81,  // 71: cerbos.private.v1.WellKnownTypes.repeated_value:type_name -> google.protobuf.Value
	83,  // 72: cerbos.private.v1.WellKnownTypes.repeated_list_value:type_name -> google.protobuf.ListValue
	51,  // 73: cerbos.private.v1.WellKnownTypes.optional_nested_msg:type_name -> cerbos.private.v1.WellKnownTypes.Nested
	19,  // 74: cerbos.private.v1.InspectTestCase.PoliciesExpectation.policies:type_name -> cerbos.private.v1.InspectTestCase.PoliciesExpectation.PoliciesEntry
	...
	20,  // 76: cerbos.private.v1.InspectTestCase.PolicySetsExpectation.compile_errors:type_name -> cerbos.private.v1.InspectTestCase.PolicySetsExpectation.CompileErrors
	...
	84,  // 78: cerbos.private.v1.InspectTestCase.PoliciesExpectation.PoliciesEntry.value:type_name -> cerbos.response.v1.InspectPoliciesResponse.Result
	57,  // 79: cerbos.private.v1.InspectTestCase.PolicySetsExpectation.CompileErrors.compile_errors:type_name -> cerbos.runtime.v1.CompileErrors.Err
	84,  // 80: cerbos.private.v1.InspectTestCase.PolicySetsExpectation.PolicySetsEntry.value:type_name -> cerbos.response.v1.InspectPoliciesResponse.Result
	24,  // 81: cerbos.private.v1.BlobClonerTestCase.File.add_or_update:type_name -> cerbos.private.v1.BlobClonerTestCase.File.AddOrUpdate
	25,  // 82: cerbos.private.v1.BlobClonerTestCase.File.delete:type_name -> cerbos.private.v1.BlobClonerTestCase.File.Delete
	27,  // 83: cerbos.private.v1.BlobClonerTestCase.Step.expectation:type_name -> cerbos.private.v1.BlobClonerTestCase.Step.Expectation
	26,  // 84: cerbos.private.v1.BlobClonerTestCase.Step.differences:type_name -> cerbos.private.v1.BlobClonerTestCase.Step.Differences
	22,  // 85: cerbos.private.v1.BlobClonerTestCase.Step.Differences.files:type_name -> cerbos.private.v1.BlobClonerTestCase.File
	30,  // 86: cerbos.private.v1.BlobClonerTestCase.Step.Expectation.all:type_name -> cerbos.private.v1.BlobClonerTestCase.Step.Expectation.AllEntry
	29,  // 87: cerbos.private.v1.BlobClonerTestCase.Step.Expectation.added_or_updated:type_name -> cerbos.private.v1.BlobClonerTestCase.Step.Expectation.Info
	29,  // 88: cerbos.private.v1.BlobClonerTestCase.Step.Expectation.deleted:type_name -> cerbos.private.v1.BlobClonerTestCase.Step.Expectation.Info
	28,  // 89: cerbos.private.v1.BlobClonerTestCase.Step.Expectation.AllEntry.value:type_name -> cerbos.private.v1.BlobClonerTestCase.Step.Expectation.Files
	85,  // 90: cerbos.private.v1.ServerTestCase.PlanResourcesCall.input:type_name -> cerbos.request.v1.PlanResourcesRequest
	86,  // 91: cerbos.private.v1.ServerTestCase.PlanResourcesCall.want_response:type_name -> cerbos.response.v1.PlanResourcesResponse
	87,  // 92: cerbos.private.v1.ServerTestCase.CheckResourceSetCall.input:type_name -> cerbos.request.v1.CheckResourceSetRequest
	88,  // 93: cerbos.private.v1.ServerTestCase.CheckResourceSetCall.want_response:type_name -> cerbos.response.v1.CheckResourceSetResponse
	89,  // 94: cerbos.private.v1.ServerTestCase.CheckResourceBatchCall.input:type_name -> cerbos.request.v1.CheckResourceBatchRequest
	90,  // 95: cerbos.private.v1.ServerTestCase.CheckResourceBatchCall.want_response:type_name -> cerbos.response.v1.CheckResourceBatchResponse
	91,  // 96: cerbos.private.v1.ServerTestCase.CheckResourcesCall.input:type_name -> cerbos.request.v1.CheckResourcesRequest
	92,  // 97: cerbos.private.v1.ServerTestCase.CheckResourcesCall.want_response:type_name -> cerbos.response.v1.CheckResourcesResponse
	93,  // 98: cerbos.private.v1.ServerTestCase.PlaygroundValidateCall.input:type_name -> cerbos.request.v1.PlaygroundValidateRequest
	94,  // 99: cerbos.private.v1.ServerTestCase.PlaygroundValidateCall.want_response:type_name -> cerbos.response.v1.PlaygroundValidateResponse
	95,  // 100: cerbos.private.v1.ServerTestCase.PlaygroundTestCall.input:type_name -> cerbos.request.v1.PlaygroundTestRequest
	96,  // 101: cerbos.private.v1.ServerTestCase.PlaygroundTestCall.want_response:type_name -> cerbos.response.v1.PlaygroundTestResponse
	97,  // 102: cerbos.private.v1.ServerTestCase.PlaygroundEvaluateCall.input:type_name -> cerbos.request.v1.PlaygroundEvaluateRequest
	98,  // 103: cerbos.private.v1.ServerTestCase.PlaygroundEvaluateCall.want_response:type_name -> cerbos.response.v1.PlaygroundEvaluateResponse
	99,  // 104: cerbos.private.v1.ServerTestCase.PlaygroundProxyCall.input:type_name -> cerbos.request.v1.PlaygroundProxyRequest
	100, // 105: cerbos.private.v1.ServerTestCase.PlaygroundProxyCall.want_response:type_name -> cerbos.response.v1.PlaygroundProxyResponse
	101, // 106: cerbos.private.v1.ServerTestCase.AdminAddOrUpdatePolicyCall.input:type_name -> cerbos.request.v1.AddOrUpdatePolicyRequest
	102, // 107: cerbos.private.v1.ServerTestCase.AdminAddOrUpdatePolicyCall.want_response:type_name -> cerbos.response.v1.AddOrUpdatePolicyResponse
	103, // 108: cerbos.private.v1.ServerTestCase.AdminAddOrUpdateSchemaCall.input:type_name -> cerbos.request.v1.AddOrUpdateSchemaRequest
	104, // 109: cerbos.private.v1.ServerTestCase.AdminAddOrUpdateSchemaCall.want_response:type_name -> cerbos.response.v1.AddOrUpdateSchemaResponse
	45,  // 110: cerbos.private.v1.CompileTestCase.Variables.derived_roles:type_name -> cerbos.private.v1.CompileTestCase.Variables.DerivedRole
	81,  // 111: cerbos.private.v1.AttrWrapper.AttrEntry.value:type_name -> google.protobuf.Value
	66,  // 112: cerbos.private.v1.QueryPlannerTestSuite.Test.want:type_name -> cerbos.engine.v1.PlanResourcesFilter
	105, // 113: cerbos.private.v1.QueryPlannerTestSuite.Test.resource:type_name -> cerbos.engine.v1.PlanResourcesInput.Resource
	66,  // 114: cerbos.private.v1.CrossScopeQueryPlannerTestSuite.Test.want:type_name -> cerbos.engine.v1.PlanResourcesFilter
	106, // 115: cerbos.private.v1.CrossScopeQueryPlannerTestSuite.Test.resource:type_name -> cerbos.engine.v1.CrossScopePlanResourcesInput.Resource
	52,  // 116: cerbos.private.v1.ProtoYamlTestCase.Want.message:type_name -> cerbos.policy.v1.Policy
	67,  // 117: cerbos.private.v1.ProtoYamlTestCase.Want.errors:type_name -> cerbos.source.v1.Error
	81,  // 118: cerbos.private.v1.WellKnownTypes.Nested.value_field:type_name -> google.protobuf.Value
