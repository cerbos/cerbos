...
You can use xref:cerbos-hub:ROOT:deployments-epdp-rules.adoc[Cerbos Hub's embedded PDPs] to evaluate your authorization policies directly in the browser.
