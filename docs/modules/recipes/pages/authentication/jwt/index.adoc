...
token and adds the payload to `req.auth`.
...
authorized. The https://www.npmjs.com/package/@cerbos/grpc[`@cerbos/grpc` package] is
used for this. Initialize the client once when the application starts:
