...
NOTE: The policies for this section can be found https://github.com/Sambigeara/cerbos/tree/docs/main/docs/modules/ROOT/examples/tutorial/08-principal-policies/cerbos[on Github].
