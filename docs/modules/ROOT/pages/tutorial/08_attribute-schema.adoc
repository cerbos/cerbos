...
NOTE: The policies for this section can be found link:{app-github-url}/tree/docs/main/docs/modules/ROOT/examples/tutorial/09-attribute-schema/cerbos[on Github].
