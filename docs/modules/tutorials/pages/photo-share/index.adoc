...
NOTE: If you like to use [Postman](https://www.postman.com), [Insomnia](https://insomnia.rest) or any software that supports OpenAPI, the Cerbos OpenAPI definitions can be downloaded by accessing http://localhost:3592{cerbos-openapi-schema}. 
...
----
{
  ...
  "meta": {
    ...
    "evaluationDuration": "0.000639087s"
  }
}
----
...
[source,yaml,linenums]
----
include::example$photo-share/tests/album_object_tests.yaml[]
----
...
== Bradley tries to view Alicia's private and public albums [OK]
== Moderator tries to delete a flagged album and an unflagged album [OK]
----
