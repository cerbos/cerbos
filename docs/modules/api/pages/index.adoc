...
* If you don't want to download protobufs and to generate code using `buf` or `protoc`, you can use the link:https://github.com/cerbos/grpc-tools[Cerbos grpc-tools docker image] to easily generate code for languages like Java, NodeJS, Python, C# etc.
