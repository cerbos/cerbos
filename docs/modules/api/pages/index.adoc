...
NOTE: You can use the link:https://github.com/cerbos/grpc-tools[Cerbos grpc-tools utility] to easily generate code for languages like Java, NodeJS, Python, C# etc. 
