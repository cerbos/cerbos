...
* If you don't want to download protobufs and to generate code yourself, you can use the link:https://github.com/cerbos/grpc-tools[Cerbos grpc-tools utility] to easily generate code for languages like Java, NodeJS, Python, C# etc.
