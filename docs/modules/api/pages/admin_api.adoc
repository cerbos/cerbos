...
Issue a GET request to the endpoint to inspect the policies in the store. If the policy store supports filtering, you
can optionally pass filter parameters to reduce the result set.
