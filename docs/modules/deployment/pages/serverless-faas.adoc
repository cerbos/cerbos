...
Deploying as a zip package requires renaming the downloaded `cerbosfunc` binary to `bootstrap` and creating a zip file with it at the root. See link:https://docs.aws.amazon.com/lambda/latest/dg/golang-package.html for more information.

[source,shell,linenums]
----
mv cerbosfunc bootstrap
...
See link:https://docs.aws.amazon.com/lambda/latest/dg/go-image.html for more information.
