...
Download the specially-built `cerbos_aws_lambda_func` archive from the link:{app-github-releases-page}[releases page], which can be deployed as either a Zip package or a container image. The archive contains a `bootstrap` binary.
