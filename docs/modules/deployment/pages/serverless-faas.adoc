...
* **Binary**: Use the `cerbosfunc` binary built by Goreleaser
* **Distribution**: Available as both ZIP package and container image
...
* **Binary**: Use the `cerbosext` binary built by Goreleaser  
