...
Firstly create your Cerbos Hub account and connect it to your policy store - see the xref:cerbos-hub:ROOT:getting-started.adoc[Cerbos Hub getting started guide] for details.
