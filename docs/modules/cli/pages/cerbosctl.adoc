...
`policy-id` flag allows to filter the policies by the policy id while listing.
...
.List derived_roles but filter policy id common_roles.yaml and other_roles.yaml
----
cerbosctl get derived_roles --policy-id=common_roles.yaml,other_roles.yaml
cerbosctl get dr --policy-id=common_roles.yaml,other_roles.yaml
----
...
.List principal_policies but filter policy id alex.yaml and john.yaml
----
cerbosctl get principal_policies --policy-id=alex.yaml,john.yaml
cerbosctl get pp --policy-id=alex.yaml,john.yaml
----
...
.List resource_policies but filter policy id leave_request.yaml and purchase_order.yaml
----
cerbosctl get resource_policies --policy-id=leave_request.yaml,purchase_order.yaml
cerbosctl get rp --policy-id=leave_request.yaml,purchase_order.yaml
----
