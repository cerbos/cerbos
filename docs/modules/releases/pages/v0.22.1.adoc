...
This is a minor patch release containing some bug fixes and usability improvements. See xref:v0.22.0.adoc[v0.22.0 release notes] for full set of changes available in the 0.22.x series.
