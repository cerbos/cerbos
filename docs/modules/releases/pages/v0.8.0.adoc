...
Variables in conditions:: You can define common CEL expressions in the new `variables` section of a policy and refer to them in conditions. This enables code reuse and easier updates to business logic with reduced opportunities for making mistakes. Please note that this feature is still unstable and will be stabilised in a future release.
