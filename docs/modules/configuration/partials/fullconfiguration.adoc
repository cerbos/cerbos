audit:
  ...
  kafka:
    ...
    format: protobuf # Data format written to Kafka, accepts either json (default) or protobuf
    produceSync: true # Reduce performance by disabling asynchronous publishing for increased reliability
