  ...
  kafka:
    ...
    authentication: # Authentication
      tls: 
        ...
        certPath: /path/to/tls.cert # Required. CertPath is the path to the client certificate.
        ...
        keyPath: /path/to/tls.key # Required. KeyPath is the path to the client key.
        reloadInterval: <DEFAULT_VALUE_NOT_SET> # ReloadInterval is the interval at which the TLS certificates are reloaded. The default is 0 (no reload).
