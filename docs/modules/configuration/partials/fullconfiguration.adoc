...
server:
  ...
  authzen: # AuthZEN defines the OpenID AuthZEN translation layer configuration.
    enabled: false # Enabled defines whether the AuthZEN HTTP API is enabled.
    listenAddr: ":3595" # ListenAddr is the dedicated HTTP address for AuthZEN.
