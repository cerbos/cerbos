audit:
  ...
  kafka:
    ...
    authentication:
      tls:
        caPath: #/path/to/ca.crt # Path to the CA certificate to use for verifying the broker's certificate.
        certPath: # /path/to/client.crt # Path to the client certificate to use for authenticating with the broker.
        keyPath: #/path/to/client.key # Path to the client key to use for authenticating with the broker.
