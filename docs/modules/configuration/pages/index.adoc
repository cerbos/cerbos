...
There are two configuration examples below, please pick one and use the configuration with Cerbos server.

Basic configuration allows having a Cerbos server set up quickly to experiment with policies.

Advanced configuration is better for creating a configuration for the production scenarios.
