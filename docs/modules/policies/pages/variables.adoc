...
---
apiVersion: api.cerbos.dev/v1
description: Common variables used by the example application
exportVariables:
  name: example_common_variables <1>
  definitions: <2>
    flagged_resource: request.resource.attr.flagged
    label: '"latest"' # assigning a string literal
    teams: '["red", "blue"]' # assigning an array literal
...
---
apiVersion: api.cerbos.dev/v1
description: Common constants used by the example application
exportConstants:
  name: example_common_constants <1>
  definitions: <2>
    label: latest
    teams:
      - red
