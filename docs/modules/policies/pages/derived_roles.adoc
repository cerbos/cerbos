...
| Cerbos matches a principal's static roles against `parentRoles`, evaluates the derived-role condition, and makes the derived role available to rules in importing resource policies that reference it.
