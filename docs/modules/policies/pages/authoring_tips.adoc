...
* The JSON schema for Cerbos files are avaliable at:
** Policy
*** `{current-policy-schema-url}` 
** xref:compile.adoc[Test suite]
*** `{current-test-schema-url}`
** xref:compile.adoc#_sharing_test_fixtures[Principal test fixtures]
*** `{current-testdata-principals-schema-url}`
** xref:compile.adoc#_sharing_test_fixtures[Resources test fixtures]
*** `{current-testdata-principals-schema-url}`
** xref:compile.adoc#_sharing_test_fixtures[AuxData test fixtures]
...
xref:compile.adoc#_sharing_test_fixtures[Resource fixtures] for tests:
...
xref:compile.adoc#_sharing_test_fixtures[Principal fixtures] for tests:
...
xref:compile.adoc#_sharing_test_fixtures[Auxiliary data fixtures] for tests:
