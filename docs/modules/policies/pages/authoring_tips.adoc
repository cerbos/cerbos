...
** xref:compile.adoc[Principal test fixtures]
*** `{current-testdata-principals-schema-url}`
** xref:compile.adoc[Resources test fixtures]
...
Resource fixtures for xref:compile.adoc[tests]:
...
Principal fixtures for xref:compile.adoc[tests]:
