...
Policies are evaluated from most to least specific. If any role policies are matched according to the above rule, they are evaluated before any resource policies, but after any principal policies.
