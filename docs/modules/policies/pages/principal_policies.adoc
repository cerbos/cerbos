...
<4> Optional name for the rule.
<5> Actions that can be performed on the resource. Wildcards are supported here.
<6> Optional conditions required to match this rule.
