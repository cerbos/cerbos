...
| format   | Format a string with the given arguments | "department_%s_%s_%d".format(["marketing", "US"])
...
| quote    | Quote escape sequences | strings.quote("'single-quote with "double quote"'")
