...
| is_subset| Checks whether the list is a subset of another list | ["design", "engineering"].is_subset(P.attr.teams)
| intersect| Produces the set intersection of two lists | intersect(["design", "engineering"], P.attr.teams)
...
| except | Produces the set difference of two lists | P.attr.teams.except(["design", "engineering"])
