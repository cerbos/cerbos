...
# Generate netlify config with redirects.
# This is only required until Antora LFS support lands. https://gitlab.com/antora/antora/-/issues/185 
cat <<EOF > "${PROJECT_DIR}/netlify.toml" 
# Generated by hack/scripts/prep-release.sh. DO NOT EDIT.
...
to = "/cerbos/${NEXT_VERSION}/_images/:splat"
status = 302
force = true

[[redirects]]
from = "/cerbos/latest/:module/_images/*"
to = "/cerbos/${NEXT_VERSION}/:module/_images/:splat"
status = 302
force = true
EOF
