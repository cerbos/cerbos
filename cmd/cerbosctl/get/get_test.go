		...
		t.Run("cerbosctl get", func(t *testing.T) {
			...
			t.Run("wrong flags in wrong commands", func(t *testing.T) {
				testCases := []struct {
					...
					{strings.Split("get derived_roles a.b.c --policy-id=a.b.c", " "), true},
					{strings.Split("get export_variables a.b.c --policy-id=a.b.c", " "), true},
					{strings.Split("get principal_policies a.b.c --policy-id=a.b.c", " "), true},
					{strings.Split("get resource_policies a.b.c --policy-id=a.b.c", " "), true},
					{strings.Split("get derived_roles --policy-id=a.b.c", " "), false},
					{strings.Split("get export_variables --policy-id=a.b.c", " "), false},
					{strings.Split("get principal_policies --policy-id=a.b.c", " "), false},
					{strings.Split("get resource_policies --policy-id=a.b.c", " "), false},
					// regexp filtering
