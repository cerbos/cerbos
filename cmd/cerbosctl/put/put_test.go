		...
		t.Run("cerbosctl put", func(t *testing.T) {
			...
			t.Run("put policies recursive", func(t *testing.T) {
				...
				require.Equal(t, []string{
					...
					"derived_roles.cel_errors.common_roles",
					"derived_roles.cel_errors.variable_roles",
					"derived_roles.doc_roles",
					...
					"resource.all_any_none.vdefault",
					...
					"resource.leave_request.vdefault/acme.hr.uk.bristol",
