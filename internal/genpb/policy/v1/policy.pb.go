...
type Test struct {
	...
	Skip           bool              `protobuf:"varint,3,opt,name=skip,proto3" json:"skip,omitempty"`
	SkipReason     string            `protobuf:"bytes,4,opt,name=skip_reason,json=skipReason,proto3" json:"skip_reason,omitempty"`
	Request        *v11.CheckRequest `protobuf:"bytes,5,opt,name=request,proto3" json:"request,omitempty"`
...
func (x *Test) GetRequest() *v11.CheckRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
var file_policy_v1_policy_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x73, 0x22, 0xfe, 0x01, 0x0a, 0x04, 0x54, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x04,
	...
	,
...
var file_policy_v1_policy_proto_goTypes = []interface{}{
	...
	(v1.Effect)(0),               // 13: shared.v1.Effect
	(*v11.CheckRequest)(nil),     // 14: request.v1.CheckRequest
}
var file_policy_v1_policy_proto_depIdxs = []int32{
	...
	13, // 5: policy.v1.ResourceRule.effect:type_name -> shared.v1.Effect
	...
	14, // 15: policy.v1.Test.request:type_name -> request.v1.CheckRequest
	13, // 16: policy.v1.Test.expected_effect:type_name -> shared.v1.Effect
	7,  // 17: policy.v1.PrincipalRule.Action.condition:type_name -> policy.v1.Condition
	13, // 18: policy.v1.PrincipalRule.Action.effect:type_name -> shared.v1.Effect
