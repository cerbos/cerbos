...
type PlaygroundRequest struct {
	...
	PolicyFiles  []*PlaygroundRequest_PolicyFile `protobuf:"bytes,2,rep,name=policy_files,json=policyFiles,proto3" json:"policy_files,omitempty"`
	Principal    *v1.Principal                   `protobuf:"bytes,3,opt,name=principal,proto3" json:"principal,omitempty"`
...
func (x *PlaygroundRequest) GetPlaygroundId() string {
	if x != nil {
...
func (x *PlaygroundRequest) GetPolicyFiles() []*PlaygroundRequest_PolicyFile {
	if x != nil {
...
func (x *PlaygroundRequest) GetPrincipal() *v1.Principal {
	if x != nil {
		return x.Principal
	}
	return nil
...
func (x *PlaygroundRequest) GetResource() *v1.Resource {
	if x != nil {
		return x.Resource
	}
	return nil
...
func (x *PlaygroundRequest) GetActions() []string {
	if x != nil {
		return x.Actions
	}
	return nil
...
type PlaygroundRequest_PolicyFile struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PlaygroundRequest_PolicyFile) Reset() {
	*x = PlaygroundRequest_PolicyFile{}
	if protoimpl.UnsafeEnabled {
...
func (x *PlaygroundRequest_PolicyFile) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlaygroundRequest_PolicyFile) ProtoMessage() {}

func (x *PlaygroundRequest_PolicyFile) ProtoReflect() protoreflect.Message {
	mi := &file_request_v1_request_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlaygroundRequest_PolicyFile.ProtoReflect.Descriptor instead.
func (*PlaygroundRequest_PolicyFile) Descriptor() ([]byte, []int) {
	return file_request_v1_request_proto_rawDescGZIP(), []int{4, 0}
}

func (x *PlaygroundRequest_PolicyFile) GetFileName() string {
	if x != nil {
		return x.FileName
	}
	return ""
...
func (x *PlaygroundRequest_PolicyFile) GetContents() []byte {
	if x != nil {
		return x.Contents
	}
	return nil
...
var file_request_v1_request_proto_rawDesc = []byte{
	...
	0x0d, 0x32, 0x0b, 0x50, 0x44, 0x50, 0x20, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xa0,
	...
	0x63, 0x79, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0xea, 0x02, 0x0a, 0x09, 0x69, 0x6e,
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e,
	...
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x1a, 0x57, 0x0a, 0x0e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	...
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x72, 0x65, 0x71, 0x75,
	...
	0x6b, 0x22, 0xc2, 0x02, 0x0a, 0x0d, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73,
	0x4d, 0x61, 0x70, 0x12, 0xaa, 0x01, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x23, 0x2e, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x76, 0x31, 0x2e,
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x4d, 0x61, 0x70, 0x2e, 0x41, 0x74,
	0x74, 0x72, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x42, 0x71, 0x92, 0x41, 0x66, 0x32, 0x64, 0x4b, 0x65,
	...
	0x6e, 0x2e, 0xfa, 0x42, 0x05, 0x9a, 0x01, 0x02, 0x18, 0x01, 0x52, 0x04, 0x61, 0x74, 0x74, 0x72,
	...
	0x01, 0x3a, 0x33, 0x92, 0x41, 0x30, 0x0a, 0x2e, 0x32, 0x2c, 0x55, 0x6e, 0x69, 0x71, 0x75, 0x65,
	...
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x22, 0xa3, 0x06, 0x0a, 0x19, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	0x62, 0x22, 0x52, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x40, 0x0a,
	0x09, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x14, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x69,
	...
	0xbb, 0x02, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x76, 0x31,
	...
	0x10, 0x14, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0xd8, 0x01,
	...
	0x52, 0x07, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x3d, 0x0a, 0x08, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x65, 0x6e,
	...
	0x0b, 0x50, 0x44, 0x50, 0x20, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xa6, 0x04, 0x0a,
	0x11, 0x50, 0x6c, 0x61, 0x79, 0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x72, 0x6f, 0x75, 0x6e, 0x64, 0x49, 0x64, 0x12, 0x7b, 0x0a, 0x0c, 0x70, 0x6f, 0x6c, 0x69, 0x63,
	0x79, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e,
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6c, 0x61, 0x79, 0x67,
	0x72, 0x6f, 0x75, 0x6e, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x50, 0x6f, 0x6c,
	...
	0x69, 0x6c, 0x65, 0x73, 0x12, 0x40, 0x0a, 0x09, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61,
	0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65,
	...
	0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x12, 0x3d, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x63, 0x0a, 0x0a, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x46,
	...
	0x52, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x3a, 0x19, 0x92, 0x41, 0x16, 0x0a,
	0x14, 0x32, 0x12, 0x50, 0x6c, 0x61, 0x79, 0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x20, 0x72, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x42, 0x59, 0x0a, 0x19, 0x64, 0x65, 0x76, 0x2e, 0x63, 0x65, 0x72,
...
var file_request_v1_request_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_request_v1_request_proto_goTypes = []interface{}{
	...
	(*PlaygroundRequest)(nil),         // 4: request.v1.PlaygroundRequest
	nil,                               // 5: request.v1.ResourceSet.InstancesEntry
	nil,                               // 6: request.v1.AttributesMap.AttrEntry
	(*CheckResourceBatchRequest_BatchEntry)(nil), // 7: request.v1.CheckResourceBatchRequest.BatchEntry
	(*PlaygroundRequest_PolicyFile)(nil),         // 8: request.v1.PlaygroundRequest.PolicyFile
	(*v1.Principal)(nil),                         // 9: engine.v1.Principal
	(*v1.Resource)(nil),                          // 10: engine.v1.Resource
	(*structpb.Value)(nil),                       // 11: google.protobuf.Value
}
var file_request_v1_request_proto_depIdxs = []int32{
	9,  // 0: request.v1.CheckResourceSetRequest.principal:type_name -> engine.v1.Principal
	1,  // 1: request.v1.CheckResourceSetRequest.resource:type_name -> request.v1.ResourceSet
	5,  // 2: request.v1.ResourceSet.instances:type_name -> request.v1.ResourceSet.InstancesEntry
	6,  // 3: request.v1.AttributesMap.attr:type_name -> request.v1.AttributesMap.AttrEntry
	9,  // 4: request.v1.CheckResourceBatchRequest.principal:type_name -> engine.v1.Principal
	7,  // 5: request.v1.CheckResourceBatchRequest.resources:type_name -> request.v1.CheckResourceBatchRequest.BatchEntry
	8,  // 6: request.v1.PlaygroundRequest.policy_files:type_name -> request.v1.PlaygroundRequest.PolicyFile
	9,  // 7: request.v1.PlaygroundRequest.principal:type_name -> engine.v1.Principal
	10, // 8: request.v1.PlaygroundRequest.resource:type_name -> engine.v1.Resource
	2,  // 9: request.v1.ResourceSet.InstancesEntry.value:type_name -> request.v1.AttributesMap
	11, // 10: request.v1.AttributesMap.AttrEntry.value:type_name -> google.protobuf.Value
	10, // 11: request.v1.CheckResourceBatchRequest.BatchEntry.resource:type_name -> engine.v1.Resource
...
func file_request_v1_request_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_request_v1_request_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PlaygroundRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_request_v1_request_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PlaygroundRequest_PolicyFile); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
