...
type ServerTestCase_CheckResourceSet struct {
	CheckResourceSet *ServerTestCase_CheckResourceSetCall `protobuf:"bytes,4,opt,name=check_resource_set,json=checkResourceSet,proto3,oneof"`
}

type ServerTestCase_CheckResourceBatch struct {
	CheckResourceBatch *ServerTestCase_CheckResourceBatchCall `protobuf:"bytes,5,opt,name=check_resource_batch,json=checkResourceBatch,proto3,oneof"`
}

type ServerTestCase_PlaygroundValidate struct {
	PlaygroundValidate *ServerTestCase_PlaygroundValidateCall `protobuf:"bytes,6,opt,name=playground_validate,json=playgroundValidate,proto3,oneof"`
}

type ServerTestCase_PlaygroundEvaluate struct {
	PlaygroundEvaluate *ServerTestCase_PlaygroundEvaluateCall `protobuf:"bytes,7,opt,name=playground_evaluate,json=playgroundEvaluate,proto3,oneof"`
}

type ServerTestCase_AdminAddOrUpdatePolicy struct {
	AdminAddOrUpdatePolicy *ServerTestCase_AdminAddOrUpdatePolicyCall `protobuf:"bytes,8,opt,name=admin_add_or_update_policy,json=adminAddOrUpdatePolicy,proto3,oneof"`
}
...
var file_cerbosdev_v1_test_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x72, 0x22, 0xbf, 0x0b, 0x0a, 0x0e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x54, 0x65,
	...
	0x52, 0x09, 0x77, 0x61, 0x6e, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x61, 0x0a, 0x12, 0x63,
	0x68, 0x65, 0x63, 0x6b, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x73, 0x65,
	0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x63, 0x65, 0x72, 0x62, 0x6f, 0x73,
	...
	0x72, 0x63, 0x65, 0x53, 0x65, 0x74, 0x43, 0x61, 0x6c, 0x6c, 0x48, 0x00, 0x52, 0x10, 0x63, 0x68,
	0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x65, 0x74, 0x12, 0x67,
	0x0a, 0x14, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x5f, 0x62, 0x61, 0x74, 0x63, 0x68, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x63,
	0x65, 0x72, 0x62, 0x6f, 0x73, 0x64, 0x65, 0x76, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x72, 0x76,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x65, 0x12, 0x75, 0x0a, 0x1a, 0x61, 0x64, 0x6d, 0x69, 0x6e,
	0x5f, 0x61, 0x64, 0x64, 0x5f, 0x6f, 0x72, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x70,
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x63, 0x65,
	0x72, 0x62, 0x6f, 0x73, 0x64, 0x65, 0x76, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65,
	...
	0x4f, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x1a, 0x9d,
	0x01, 0x0a, 0x14, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x53, 0x65, 0x74, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x39, 0x0a, 0x05, 0x69, 0x6e, 0x70, 0x75, 0x74,
	...
	0x75, 0x74, 0x12, 0x4a, 0x0a, 0x0d, 0x77, 0x61, 0x6e, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x72, 0x65, 0x73, 0x70,
	...
	0x52, 0x0c, 0x77, 0x61, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x1a, 0xa3,
	0x01, 0x0a, 0x16, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x42, 0x61, 0x74, 0x63, 0x68, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x3b, 0x0a, 0x05, 0x69, 0x6e, 0x70,
	0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x72, 0x65, 0x71, 0x75, 0x65,
	...
	0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x4c, 0x0a, 0x0d, 0x77, 0x61, 0x6e, 0x74, 0x5f, 0x72,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x1a, 0xa3, 0x01, 0x0a, 0x16, 0x50, 0x6c, 0x61, 0x79, 0x67, 0x72, 0x6f,
	...
	0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x0c, 0x77, 0x61,
	...
	0x1a, 0xa5, 0x01, 0x0a, 0x1a, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x41, 0x64, 0x64, 0x4f, 0x72, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x43, 0x61, 0x6c, 0x6c, 0x12,
	0x3a, 0x0a, 0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24,
	...
	0x75, 0x65, 0x73, 0x74, 0x52, 0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x4b, 0x0a, 0x0d, 0x77,
	0x61, 0x6e, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x26, 0x2e, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x76, 0x31,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0b, 0x0a, 0x09, 0x63, 0x61, 0x6c, 0x6c,
	0x5f, 0x6b, 0x69, 0x6e, 0x64, 0x22, 0xd4, 0x01, 0x0a, 0x14, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x42,
	0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x12, 0x43,
	0x0a, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e,
	0x63, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x64, 0x65, 0x76, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x64,
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x61, 0x69, 0x6e, 0x44, 0x65, 0x66, 0x12, 0x4b, 0x0a, 0x0a, 0x69,
	0x6e, 0x70, 0x75, 0x74, 0x5f, 0x64, 0x65, 0x66, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x2c, 0x2e, 0x63, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x64, 0x65, 0x76, 0x2e, 0x76, 0x31, 0x2e, 0x43,
	...
	0x6e, 0x70, 0x75, 0x74, 0x44, 0x65, 0x66, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x77, 0x61, 0x6e, 0x74,
	0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x77,
	0x61, 0x6e, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x1a, 0x4f, 0x0a, 0x0e, 0x49, 0x6e, 0x70,
	0x75, 0x74, 0x44, 0x65, 0x66, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb3, 0x01, 0x0a, 0x0f, 0x43,
	0x6f, 0x64, 0x65, 0x47, 0x65, 0x6e, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x12, 0x34,
	0x0a, 0x0c, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x5f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x18, 0x01,
	...
	0x22, 0x9d, 0x01, 0x0a, 0x0b, 0x43, 0x65, 0x6c, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65,
	...
	0x15, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x52, 0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x12, 0x0a,
	0x04, 0x77, 0x61, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x77, 0x61, 0x6e,
	0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x77, 0x61, 0x6e, 0x74, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x77, 0x61, 0x6e, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72,
...
var file_cerbosdev_v1_test_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_cerbosdev_v1_test_proto_goTypes = []interface{}{
	...
	nil,                                    // 11: cerbosdev.v1.IndexBuilderTestCase.FilesEntry
	nil,                                    // 12: cerbosdev.v1.CompileTestCase.InputDefsEntry
	(*v1.CheckInput)(nil),                  // 13: engine.v1.CheckInput
	(*v1.CheckOutput)(nil),                 // 14: engine.v1.CheckOutput
	(*v11.Policy)(nil),                     // 15: policy.v1.Policy
	(*v11.Match)(nil),                      // 16: policy.v1.Match
	(*v12.CheckResourceSetRequest)(nil),    // 17: request.v1.CheckResourceSetRequest
	(*v13.CheckResourceSetResponse)(nil),   // 18: response.v1.CheckResourceSetResponse
	(*v12.CheckResourceBatchRequest)(nil),  // 19: request.v1.CheckResourceBatchRequest
	(*v13.CheckResourceBatchResponse)(nil), // 20: response.v1.CheckResourceBatchResponse
	(*v12.PlaygroundValidateRequest)(nil),  // 21: request.v1.PlaygroundValidateRequest
	(*v13.PlaygroundValidateResponse)(nil), // 22: response.v1.PlaygroundValidateResponse
	(*v12.PlaygroundEvaluateRequest)(nil),  // 23: request.v1.PlaygroundEvaluateRequest
	(*v13.PlaygroundEvaluateResponse)(nil), // 24: response.v1.PlaygroundEvaluateResponse
	(*v12.AddOrUpdatePolicyRequest)(nil),   // 25: request.v1.AddOrUpdatePolicyRequest
	(*v13.AddOrUpdatePolicyResponse)(nil),  // 26: response.v1.AddOrUpdatePolicyResponse
}
var file_cerbosdev_v1_test_proto_depIdxs = []int32{
	13, // 0: cerbosdev.v1.EngineTestCase.inputs:type_name -> engine.v1.CheckInput
	14, // 1: cerbosdev.v1.EngineTestCase.want_outputs:type_name -> engine.v1.CheckOutput
	6,  // 2: cerbosdev.v1.ServerTestCase.check_resource_set:type_name -> cerbosdev.v1.ServerTestCase.CheckResourceSetCall
	7,  // 3: cerbosdev.v1.ServerTestCase.check_resource_batch:type_name -> cerbosdev.v1.ServerTestCase.CheckResourceBatchCall
	8,  // 4: cerbosdev.v1.ServerTestCase.playground_validate:type_name -> cerbosdev.v1.ServerTestCase.PlaygroundValidateCall
	9,  // 5: cerbosdev.v1.ServerTestCase.playground_evaluate:type_name -> cerbosdev.v1.ServerTestCase.PlaygroundEvaluateCall
	10, // 6: cerbosdev.v1.ServerTestCase.admin_add_or_update_policy:type_name -> cerbosdev.v1.ServerTestCase.AdminAddOrUpdatePolicyCall
	11, // 7: cerbosdev.v1.IndexBuilderTestCase.files:type_name -> cerbosdev.v1.IndexBuilderTestCase.FilesEntry
	12, // 8: cerbosdev.v1.CompileTestCase.input_defs:type_name -> cerbosdev.v1.CompileTestCase.InputDefsEntry
	15, // 9: cerbosdev.v1.CodeGenTestCase.input_policy:type_name -> policy.v1.Policy
	16, // 10: cerbosdev.v1.CelTestCase.condition:type_name -> policy.v1.Match
	13, // 11: cerbosdev.v1.CelTestCase.input:type_name -> engine.v1.CheckInput
	17, // 12: cerbosdev.v1.ServerTestCase.CheckResourceSetCall.input:type_name -> request.v1.CheckResourceSetRequest
	18, // 13: cerbosdev.v1.ServerTestCase.CheckResourceSetCall.want_response:type_name -> response.v1.CheckResourceSetResponse
	19, // 14: cerbosdev.v1.ServerTestCase.CheckResourceBatchCall.input:type_name -> request.v1.CheckResourceBatchRequest
	20, // 15: cerbosdev.v1.ServerTestCase.CheckResourceBatchCall.want_response:type_name -> response.v1.CheckResourceBatchResponse
	21, // 16: cerbosdev.v1.ServerTestCase.PlaygroundValidateCall.input:type_name -> request.v1.PlaygroundValidateRequest
	22, // 17: cerbosdev.v1.ServerTestCase.PlaygroundValidateCall.want_response:type_name -> response.v1.PlaygroundValidateResponse
	23, // 18: cerbosdev.v1.ServerTestCase.PlaygroundEvaluateCall.input:type_name -> request.v1.PlaygroundEvaluateRequest
	24, // 19: cerbosdev.v1.ServerTestCase.PlaygroundEvaluateCall.want_response:type_name -> response.v1.PlaygroundEvaluateResponse
	25, // 20: cerbosdev.v1.ServerTestCase.AdminAddOrUpdatePolicyCall.input:type_name -> request.v1.AddOrUpdatePolicyRequest
	26, // 21: cerbosdev.v1.ServerTestCase.AdminAddOrUpdatePolicyCall.want_response:type_name -> response.v1.AddOrUpdatePolicyResponse
	15, // 22: cerbosdev.v1.CompileTestCase.InputDefsEntry.value:type_name -> policy.v1.Policy
