...
import (
	...
	_ "github.com/cerbos/cerbos/internal/genpb/response/v1"
...
var file_cerbosdev_v1_test_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x72, 0x22, 0xeb, 0x01, 0x0a, 0x0f, 0x43, 0x6f, 0x6d, 0x70, 0x69, 0x6c, 0x65, 0x54,
...
var file_cerbosdev_v1_test_proto_goTypes = []interface{}{
	...
	(*v1.CheckInput)(nil),   // 5: engine.v1.CheckInput
	(*v1.CheckOutput)(nil),  // 6: engine.v1.CheckOutput
	(*v11.Policy)(nil),      // 7: policy.v1.Policy
	(*v11.Match)(nil),       // 8: policy.v1.Match
}
var file_cerbosdev_v1_test_proto_depIdxs = []int32{
	5, // 0: cerbosdev.v1.EngineTestCase.inputs:type_name -> engine.v1.CheckInput
	6, // 1: cerbosdev.v1.EngineTestCase.want_outputs:type_name -> engine.v1.CheckOutput
	...
	5, // 5: cerbosdev.v1.CelTestCase.input:type_name -> engine.v1.CheckInput
