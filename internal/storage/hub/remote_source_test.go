...
func TestRemoteSource(t *testing.T) {
	...
	t.Run("WithoutAutoUpdate", func(t *testing.T) {
		...
		t.Run("BootstrapSuccess", func(t *testing.T) {
			...
			mockClient.EXPECT().BootstrapBundle(mock.Anything, deploymentID).Return(tctx.bundlePath, bundlev2.BundleType_BUNDLE_TYPE_RULE_TABLE, loadEncryptionKey(t, tctx), nil).Once()
		...
		t.Run("BootstrapFail", func(t *testing.T) {
			...
			mockClient.EXPECT().BootstrapBundle(mock.Anything, deploymentID).Return("", bundlev2.BundleType_BUNDLE_TYPE_RULE_TABLE, nil, bundleapi.ErrBootstrapBundleResponseNotFound).Once()
			mockClient.EXPECT().GetBundle(mock.Anything, deploymentID).Return(tctx.bundlePath, bundlev2.BundleType_BUNDLE_TYPE_RULE_TABLE, loadEncryptionKey(t, tctx), nil).Once()
		...
		t.Run("BootstrapAndAPIFailure", func(t *testing.T) {
			...
			mockClient.EXPECT().BootstrapBundle(mock.Anything, deploymentID).Return("", bundlev2.BundleType_BUNDLE_TYPE_RULE_TABLE, nil, errors.New("fail")).Once()
			mockClient.EXPECT().GetBundle(mock.Anything, deploymentID).Return("", bundlev2.BundleType_BUNDLE_TYPE_RULE_TABLE, nil, errors.New("fail")).Once()
		...
		t.Run("Reload", func(t *testing.T) {
			...
			mockClient.EXPECT().BootstrapBundle(mock.Anything, deploymentID).Return(tctx.bundlePath, bundlev2.BundleType_BUNDLE_TYPE_RULE_TABLE, loadEncryptionKey(t, tctx), nil).Twice()
		...
		t.Run("Playground", func(t *testing.T) {
			...
			mockClient.EXPECT().BootstrapBundle(mock.Anything, playgroundID).Return("", bundlev2.BundleType_BUNDLE_TYPE_RULE_TABLE, nil, bundleapi.ErrBootstrappingNotSupported).Once()
			bundleName := "bundle_unencrypted.crrt"
			mockClient.EXPECT().GetBundle(mock.Anything, playgroundID).Return(filepath.Join(tctx.rootDir, bundleName), bundlev2.BundleType_BUNDLE_TYPE_RULE_TABLE, nil, nil).Once()
	...
	t.Run("WithAutoUpdate", func(t *testing.T) {
		...
		t.Run("BundleRemoved", func(t *testing.T) {
			...
			events := []bundleapi.ServerEvent{
				{Kind: bundleapi.ServerEventNewBundle, NewBundlePath: tctx.bundlePath, BundleType: bundlev2.BundleType_BUNDLE_TYPE_RULE_TABLE},
			...
			mockClient.EXPECT().BootstrapBundle(mock.Anything, deploymentID).Return(tctx.bundlePath, bundlev2.BundleType_BUNDLE_TYPE_RULE_TABLE, encryptionKey, nil).Once()
