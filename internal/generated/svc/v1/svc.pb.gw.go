...
import (
	...
	"github.com/cerbos/cerbos/internal/generated/request/v1"
...
var (
	pattern_CerbosService_Check_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "check"}, ""))
)
