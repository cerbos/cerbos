...
func (_c *Store_ListPolicyIDs_Call) Run(run func(_a0 context.Context, _a1 bool)) *Store_ListPolicyIDs_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Store_ListPolicyIDs_Call) RunAndReturn(run func(context.Context, bool) ([]string, error)) *Store_ListPolicyIDs_Call {
	_c.Call.Return(run)
	return _c
}
