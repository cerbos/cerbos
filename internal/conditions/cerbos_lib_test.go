...
func TestCerbosLib(t *testing.T) {
	testCases := []struct {
		...
		{expr: `pathMatch("\\\\host\\share\\file.zip", "\\\\host\\share\\*.zip") == true`},
		{expr: `pathMatch("C:\\path\\to\\file.zip", "C:\\path\\to\\*.zip") == true`},
		{expr: `"/path/to/file.zip".pathMatch("/path/to/*.zip") == true`},
		{expr: `"\\\\host\\share\\file.zip".pathMatch("\\\\host\\share\\*.zip") == true`},
		...
		{expr: `relPath("\\\\host\\share", "\\\\host\\share\\file.txt") == "file.txt"`},
		{expr: `relPath("C:\\path\\to", "C:\\path\\to\\file.txt") == "file.txt"`},
		{expr: `volumeName("/path/to/dir") == ""`},
		{expr: `volumeName("\\\\host\\share\\dir") == "\\\\host\\share"`},
		{expr: `volumeName("C:\\path\\to\\dir") == "C:"`},
	}
