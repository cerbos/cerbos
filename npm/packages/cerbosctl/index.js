...
if (!supportedPlatforms.includes(currentPlatform)) {
  throw new Error(`Your current operating system (${os}) and architecture (${arch}) is not supported by the cerbosctl npm package.
...
const binaryPackage = `@cerbos/cerbosctl-${os}-${arch}`;
